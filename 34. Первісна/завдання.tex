...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 53 (НМТ 2023~--- 15, 2024~--- 14, 2025~--- 10, 2026~--- 14).}\par\vspace{0.2cm}
...
\noindent\zadnum Обчисліть інтеграл $\displaystyle\int\limits_{-2}^{1} (x^2 + 4x) dx$. \nmtyear{2023}
...
\vspace{0.3cm}
\answerTable{$3x^2$}{$3x$}{$2x^2$}{$3x^2 + 4$}{$\dfrac{x^4}{4} + C$}
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        % Підписи
        \node[above] at (axis cs:3, 6) {$y=f(x)$};
...
\vspace{0.3cm}
\answerTable{11}{42}{17}{52}{$\frac{14}{3}$}
...
\begin{multicols}{3}\noindent
\noindent\textbf{40.}~$64$ \ {\scriptsize\color{gray}(23.05, №20)}\par
\noindent\textbf{41.}~А \ {\scriptsize\color{gray}(30.05, №11)}\par
\noindent\textbf{42.}~$1{,}5$ \ {\scriptsize\color{gray}(1.06, №19)}\par
\noindent\textbf{43.}~$6{,}75$ \ {\scriptsize\color{gray}(2.06, №19)}\par
\noindent\textbf{44.}~Д \ {\scriptsize\color{gray}(3.06, №10)}\par
\noindent\textbf{45.}~$4{,}5$ \ {\scriptsize\color{gray}(4.06, №20)}\par
\noindent\textbf{51.}~Б \ {\scriptsize\color{gray}(15.06, №10)}\par
\noindent\textbf{52.}~$35.5$ \ {\scriptsize\color{gray}(17.06, №19)}\par
\noindent\textbf{53.}~$7{,}5$ \ {\scriptsize\color{gray}(19.06, №19)}\par
\end{multicols}
\fi
