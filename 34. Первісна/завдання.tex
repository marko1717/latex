...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 52 (НМТ \mbox{2023~--- 14}, \mbox{2024~--- 14}, \mbox{2025~--- 10}, \mbox{2026~--- 14}).}\par\vspace{0.2cm}
...
\begin{nmtfit}\begin{tikzpicture}
    \begin{axis}[
        ...
        \node[fill=white, inner sep=1.5pt, below] at (axis cs:2, -1.3) {$y=f(x)$};
...
\begin{nmtfit}\begin{tikzpicture}
    \begin{axis}[
        ...
        \node[fill=white, inner sep=1.5pt, right] at (axis cs:3, 1.5) {$y=f(x)$};
    \end{axis}
\end{tikzpicture}\end{nmtfit}
\end{center}
\end{minipage}
...
\begin{nmtfit}\begin{tikzpicture}
    \begin{axis}[
        ...
        \node[fill=white, inner sep=1.5pt, right] at (axis cs:7.2, 8) {$y=f(x)$};
        \node[below left] at (axis cs:0,0) {$0$};
    \end{axis}
\end{tikzpicture}\end{nmtfit}
\end{center}
...
\begin{nmtfit}\begin{tikzpicture}
    \begin{axis}[
        ...
        \node[fill=white, inner sep=1.5pt, right] at (axis cs:2.5, 4.5) {$y=f(x)$};
        \node[below left] at (axis cs:0,0) {$0$};
    \end{axis}
\end{tikzpicture}\end{nmtfit}
\end{center}
...
\begin{nmtfit}\begin{tikzpicture}
    \begin{axis}[
        ...
        % Підписи
        \node[fill=white, inner sep=1.5pt, above] at (axis cs:3, 6) {$y=f(x)$};
...
\begin{multicols}{3}\noindent
\noindent\textbf{39.}~$64$ \ {\scriptsize\color{gray}(23.05, №20)}\par
\noindent\textbf{40.}~А \ {\scriptsize\color{gray}(30.05, №11)}\par
\noindent\textbf{41.}~$1{,}5$ \ {\scriptsize\color{gray}(1.06, №19)}\par
\noindent\textbf{42.}~$6{,}75$ \ {\scriptsize\color{gray}(2.06, №19)}\par
\noindent\textbf{43.}~Д \ {\scriptsize\color{gray}(3.06, №10)}\par
\noindent\textbf{44.}~$4{,}5$ \ {\scriptsize\color{gray}(4.06, №20)}\par
\noindent\textbf{50.}~Б \ {\scriptsize\color{gray}(15.06, №10)}\par
