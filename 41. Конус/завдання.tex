...
\noindent{\small\color{gray!80} Розділ 5. Стереометрія \quad\textbullet\quad Усього завдань: 32 (НМТ \mbox{2023~--- 8}, \mbox{2024~--- 6}, \mbox{2025~--- 7}, \mbox{2026~--- 11}).}\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{22.}~$5120$ \ {\scriptsize\color{gray}(23.05, №19)}\par
\noindent\textbf{23.}~$1664$ \ {\scriptsize\color{gray}(30.05, №21)}\par
\noindent\textbf{24.}~$64$ \ {\scriptsize\color{gray}(1.06, №21)}\par
\noindent\textbf{25.}~$1{,}5$ \ {\scriptsize\color{gray}(2.06, №21)}\par
\noindent\textbf{26.}~Г \ {\scriptsize\color{gray}(3.06, №6)}\par
\noindent\textbf{27.}~$1632$ \ {\scriptsize\color{gray}(5.06, №21)}\par
\noindent\textbf{29.}~$180$ \ {\scriptsize\color{gray}(15.06, №21)}\par
\noindent\textbf{30.}~Г \ {\scriptsize\color{gray}(17.06, №5)}\par
