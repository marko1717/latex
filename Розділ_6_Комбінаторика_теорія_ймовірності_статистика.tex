...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2023--2026 \textendash{} Розділ 6}
...
\vspace*{2cm}
\begin{center}
{\Huge\bfseries\color{mainGreen} РОЗДІЛ 6}\\[0.4cm]
{\LARGE\bfseries\color{mainGreen} Комбінаторика, теорія ймовірності, статистика}\\[0.6cm]
{\Large База завдань НМТ 2023--2026}\\[0.8cm]
{\large Теми: 35, 36, 37}\\[1.2cm]
