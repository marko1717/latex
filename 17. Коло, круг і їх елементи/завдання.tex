...
\noindent{\small\color{gray!80} Розділ 4. Планіметрія \quad\textbullet\quad Усього завдань: 72 (НМТ \mbox{2023~--- 22}, \mbox{2024~--- 19}, \mbox{2025~--- 11}, \mbox{2026~--- 20}).}\par\vspace{0.2cm}
...
\matchingLayout{
    \textit{Кут} \par\par\vspace{0.2cm}
    \textbf{1} \quad $\angle BAC$ \\
    \textbf{2} \quad $\angle KBC$ \\
    \textbf{3} \quad $\angle OKB$
}{
    \textit{Градусна міра кута} \par\par\vspace{0.2cm}
    \begin{tabular}{ll}
    \textbf{А} & $24^\circ$ \\
    \textbf{Б} & $34^\circ$ \\
    \textbf{В} & $42^\circ$ \\
...
\matchingLayout{
    \textit{Геометрична фігура} \par\par\vspace{0.2cm}
    ...
    \textit{Радіус кола, вписаного у фігуру} \par\par\vspace{0.2cm}
    \begin{tabular}{ll}
    \textbf{А} & 4 \textit{см} \\
...
\begin{multicols}{3}\noindent
\noindent\textbf{53.}~А \ {\scriptsize\color{gray}(23.05, №10)}\par
\noindent\textbf{54.}~Г \ {\scriptsize\color{gray}(30.05, №15)}\par
\noindent\textbf{55.}~А \ {\scriptsize\color{gray}(1.06, №3)}\par
\noindent\textbf{56.}~Д \ {\scriptsize\color{gray}(1.06, №10)}\par
\noindent\textbf{57.}~1~--~Г, 2~--~Б, 3~--~В \ {\scriptsize\color{gray}(2.06, №18)}\par
\noindent\textbf{58.}~Г \ {\scriptsize\color{gray}(3.06, №9)}\par
\noindent\textbf{59.}~В \ {\scriptsize\color{gray}(3.06, №14)}\par
\noindent\textbf{60.}~Д \ {\scriptsize\color{gray}(4.06, №9)}\par
\noindent\textbf{61.}~Д \ {\scriptsize\color{gray}(5.06, №3)}\par
\noindent\textbf{69.}~1--А; 2--Г; 3--Д \ {\scriptsize\color{gray}(16.06, №18)}\par
\noindent\textbf{70.}~В \ {\scriptsize\color{gray}(17.06, №9)}\par
\noindent\textbf{71.}~Б \ {\scriptsize\color{gray}(18.06, №14)}\par
\noindent\textbf{72.}~Б \ {\scriptsize\color{gray}(19.06, №9)}\par
\end{multicols}
\fi
