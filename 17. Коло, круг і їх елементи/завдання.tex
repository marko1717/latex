...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2022--2026 \textendash{} Тема 17}
...
\matchHead{Відрізок}
\matchItem{1}{$AC$}
\matchItem{2}{висота, проведена з \par \quad вершини $B$}
\matchItem{3}{радіус кола, \par \quad описаного навколо \par \quad трикутника $ABC$}
}{
\matchHead{Довжина відрізка}
...
\matchHead{Відрізок}
\matchItem{1}{$AC$}
\matchItem{2}{найбільша середня \par \quad лінія трикутника $ABC$}
\matchItem{3}{$AM$}
}{
\matchHead{Довжина відрізка}
    \matchItem{А}{10 \textit{см}}
