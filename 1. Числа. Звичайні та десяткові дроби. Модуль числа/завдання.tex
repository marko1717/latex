...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2022--2026 \textendash{} Тема 1}
...
\noindent{\small\color{gray!80} Розділ 1. Числа і вирази \quad\textbullet\quad Усього завдань: 45 (НМТ \mbox{2023~--- 10}, \mbox{2024~--- 14}, \mbox{2025~--- 12}, \mbox{2026~--- 9}); \mbox{тестових~--- 28}; \mbox{на відповідність~--- 17}.}\par\vspace{0.2cm}
...
\matchingLayout{
\matchHead{Вираз}
\matchItem{1}{$\sin \dfrac{7\pi}{2}$}
\matchItem{2}{$\pi^{\cos 90°}$}
\matchItem{3}{$\dfrac{\pi}{3}$}
}{
...
\matchingLayout{
\matchHead{Вираз}
\matchItem{1}{$\mathrm{tg}\,\dfrac{\pi}{3}$}
\matchItem{2}{$1 - \pi$}
...
\matchingLayout{
\matchHead{Вираз}
\matchItem{1}{$\left|\dfrac{5}{3} - 2\right|$}
\matchItem{2}{$3^{-2} \cdot \left(\dfrac{1}{3}\right)^{-3}$}
\matchItem{3}{$\sqrt{3} \cdot \sin\dfrac{\pi}{3}$}
}{
\matchHead{Значення}
\matchItem{А}{$\dfrac{3}{2}$}
\matchItem{Б}{$3$}
...
\matchingLayout{
\matchHead{Вираз}
\matchItem{1}{$\cos\left(-\dfrac{\pi}{3}\right)$}
\matchItem{2}{$\log_\pi \dfrac{1}{\pi}$}
\matchItem{3}{$|1 - \pi| - |\pi - 1|$}
}{
...
\begin{multicols}{3}\noindent
\noindent\textbf{25.}~В \ {\scriptsize\color{gray}(3.06, №7)}\par
\noindent\textbf{28.}~Г \ {\scriptsize\color{gray}(19.06, №1)}\par
\noindent\textbf{41.}~1~--~В, 2~--~Б, 3~--~А \ {\scriptsize\color{gray}(23.05, №17)}\par
