...
\answerTable{$17$}{$13$}{$18$}{$15$}{$19$}

\vspace{0.5cm}

% Завдання 2
\task{2}{$|2 - \sqrt{7}| =$ \nmtyear{2023}}
\answerTable{$2 - \sqrt{7}$}{$2 + \sqrt{7}$}{$\sqrt{3}$}{$\sqrt{7} - 2$}{$\sqrt{5}$}
...
\answerTableBig{$\dfrac{1}{2}$}{$-\dfrac{5}{3}$}{$\dfrac{12}{5}$}{$-\dfrac{1}{2}$}{$\dfrac{5}{3}$}

\vspace{0.5cm}

% Завдання 5
\task{5}{$|2 - 5 \cdot 3| =$ \nmtyear{2023}}
\answerTable{$13$}{$-9$}{$9$}{$-13$}{$17$}

\vspace{0.5cm}

% Завдання 6
\task{6}{$|\sqrt{8} - 5| =$ \nmtyear{2023}}
\answerTable{$-\sqrt{8} - 5$}{$\sqrt{8} - 5$}{$5 - \sqrt{8}$}{$\sqrt{8} + 5$}{$\sqrt{3}$}

\vspace{0.5cm}

% Завдання 7
\task{7}{$3 \cdot \left(-\dfrac{1}{15}\right) =$ \nmtyear{2023}}
\answerTableBig{$\dfrac{1}{5}$}{$\dfrac{44}{15}$}{$-\dfrac{1}{5}$}{$-5$}{$\dfrac{2}{15}$}
...
\answerTableBig{$1\dfrac{2}{3}$}{$-\dfrac{1}{6}$}{$-\dfrac{2}{3}$}{$\dfrac{2}{3}$}{$-6$}
...
\answerTable{$5$}{$-5$}{$17$}{$2$}{$-17$}

\vspace{0.5cm}

% Завдання 2
\task{2}{$|1 - 0{,}5^{-2}| =$ \nmtyear{2024}}
\answerTable{$1$}{$2$}{$3$}{$1{,}25$}{$0$}
...
\answerTable{$9$}{$6$}{$7$}{$5$}{$8$}

\vspace{0.5cm}

% Завдання 5
\task{5}{$\left|4{,}2 - \dfrac{68}{10}\right| =$ \nmtyear{2024}}
\answerTable{$2{,}4$}{$-2{,}4$}{$-2{,}6$}{$1{,}6$}{$2{,}6$}

\vspace{0.5cm}

% Завдання 6
\task{6}{$|1 - 4 \cdot 2{,}5| =$ \nmtyear{2024}}
\answerTable{$-9$}{$9$}{$-11$}{$7{,}5$}{$11$}
...
\answerTableBig{$1\dfrac{1}{4}$}{$-\dfrac{1}{4}$}{$\dfrac{5}{8}$}{$\dfrac{1}{4}$}{$2\dfrac{5}{8}$}
...
% Завдання 3
\task{3}{$|2\sqrt{2} - 3| =$ \nmtyear{2025}}
\answerTable{$3 - 2\sqrt{2}$}{$\sqrt{2}$}{$2\sqrt{2} + 3$}{$2\sqrt{2} - 3$}{$-2\sqrt{2} - 3$}

\vspace{0.5cm}

% Завдання 4
\task{4}{$3 : 0{,}3 =$ \nmtyear{2025}}
\answerTableBig{$10$}{$0{,}1$}{$2{,}7$}{$0{,}9$}{$\dfrac{1}{9}$}
...
\answerTable{$2{,}25$}{$1{,}5$}{$0{,}2$}{$2{,}5$}{$-2{,}5$}

\vspace{0.5cm}

% Завдання 11
\task{11}{Якщо $a < -2$, то $1 - |a - 2| =$ \nmtyear{2025}}
\answerTable{$-a - 1$}{$a - 1$}{$-a + 3$}{$-a - 3$}{$a + 3$}

\vspace{0.5cm}

% Завдання 12
\task{12}{$|1 - 0{,}5^{-3}| =$ \nmtyear{2025}}
\answerTable{$1{,}125$}{$0{,}875$}{$1{,}5$}{$7$}{$0{,}125$}

\vspace{0.5cm}

% Завдання 13
\task{13}{Округліть до сотих число $1{,}31499$. \nmtyear{2025}}
\answerTable{$1{,}32$}{$1{,}315$}{$1{,}314$}{$1{,}31$}{$1{,}3$}
