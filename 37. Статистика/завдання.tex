...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2022--2026 \textendash{} Тема 37}
...
\noindent{\small\color{gray!80} Розділ 6. Комбінаторика, теорія ймовірності, статистика \quad\textbullet\quad Усього завдань: 75 (НМТ \mbox{2023~--- 14}, \mbox{2024~--- 22}, \mbox{2025~--- 18}, \mbox{2026~--- 21}); \mbox{тестових~--- 48}; \mbox{з короткою відповіддю~--- 27}.}\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{31.}~Г \ {\scriptsize\color{gray}(23.05, №14)}\par
\noindent\textbf{32.}~В \ {\scriptsize\color{gray}(30.05, №4)}\par
\noindent\textbf{33.}~В \ {\scriptsize\color{gray}(2.06, №6)}\par
\noindent\textbf{34.}~Б \ {\scriptsize\color{gray}(3.06, №2)}\par
\noindent\textbf{35.}~В \ {\scriptsize\color{gray}(4.06, №2)}\par
\noindent\textbf{36.}~Б \ {\scriptsize\color{gray}(5.06, №2)}\par
\noindent\textbf{42.}~А \ {\scriptsize\color{gray}(15.06, №2)}\par
\noindent\textbf{43.}~Д \ {\scriptsize\color{gray}(15.06, №11)}\par
\noindent\textbf{44.}~В \ {\scriptsize\color{gray}(16.06, №2)}\par
\noindent\textbf{45.}~Б \ {\scriptsize\color{gray}(17.06, №2)}\par
\noindent\textbf{46.}~Б \ {\scriptsize\color{gray}(18.06, №2)}\par
\noindent\textbf{47.}~Б \ {\scriptsize\color{gray}(18.06, №11)}\par
\noindent\textbf{48.}~Д \ {\scriptsize\color{gray}(19.06, №2)}\par
\noindent\textbf{74.}~$1430$ \ {\scriptsize\color{gray}(15.06, №20)}\par
\noindent\textbf{75.}~$18$ \ {\scriptsize\color{gray}(18.06, №20)}\par
\end{multicols}
\fi
