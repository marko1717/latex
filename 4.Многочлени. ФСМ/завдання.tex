...
\noindent{\small\color{gray!80} Розділ 1. Числа і вирази \quad\textbullet\quad Усього завдань: 47 (НМТ \mbox{2023~--- 8}, \mbox{2024~--- 12}, \mbox{2025~--- 18}, \mbox{2026~--- 9}); \mbox{тестових~--- 32}; \mbox{на відповідність~--- 15}.}\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{26.}~А \ {\scriptsize\color{gray}(2.06, №2)}\par
\noindent\textbf{27.}~А \ {\scriptsize\color{gray}(5.06, №6)}\par
\noindent\textbf{30.}~В \ {\scriptsize\color{gray}(15.06, №3)}\par
\noindent\textbf{31.}~Г \ {\scriptsize\color{gray}(18.06, №6)}\par
\noindent\textbf{32.}~В \ {\scriptsize\color{gray}(19.06, №6)}\par
\noindent\textbf{46.}~1~--~Б, 2~--~Г, 3~--~А \ {\scriptsize\color{gray}(3.06, №16)}\par
\end{multicols}
\fi
