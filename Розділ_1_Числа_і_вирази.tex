...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2023--2026 \textendash{} Розділ 1}
...
\vspace*{2cm}
\begin{center}
{\Huge\bfseries\color{mainGreen} РОЗДІЛ 1}\\[0.4cm]
{\LARGE\bfseries\color{mainGreen} Числа і вирази}\\[0.6cm]
{\Large База завдань НМТ 2023--2026}\\[0.8cm]
{\large Теми: 1, 2, 3, 4, 5, 7, 26, 30a}\\[1.2cm]
