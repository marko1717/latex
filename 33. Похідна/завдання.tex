...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2022--2026 \textendash{} Тема 33}
...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 43 (НМТ \mbox{2023~--- 11}, \mbox{2024~--- 12}, \mbox{2025~--- 10}, \mbox{2026~--- 10}); \mbox{тестових~--- 15}; \mbox{на відповідність~--- 3}; \mbox{з короткою відповіддю~--- 25}.}\par\vspace{0.2cm}
...
\begin{nmtfit}\begin{tikzpicture}
    \begin{axis}[
        ...
        \node[below left] at (axis cs:0,0) {0};
        \node[right, fill=white, inner sep=1.5pt] at (axis cs:1, 3.5) {$y=f(x)$};
    \end{axis}
\end{tikzpicture}\end{nmtfit}
\end{center}
\end{minipage}
...
\begin{nmtfit}\begin{tikzpicture}
    \begin{axis}[
        ...
        % Підпис функції
        \node[right, fill=white, inner sep=1.5pt] at (axis cs:1.5, 4) {$y=f(x)$};
    \end{axis}
\end{tikzpicture}\end{nmtfit}
\end{center}
\end{minipage}
...
\matchingLayout{
\matchHead{Початок речення}
\matchItem{1}{Найменше значення функції $y=f(x)$}
\matchItem{2}{Точка екстремуму функції $y=f(x)-5$}
\matchItem{3}{Нуль функції $y=f(x+2)$}
}{
\matchHead{Закінчення речення}
    \matchItem{А}{дорівнює $-3$.}
\matchItem{Б}{дорівнює $-2$.}
\matchItem{В}{дорівнює $0$.}
\matchItem{Г}{дорівнює $2$.}
\matchItem{Д}{дорівнює $3$.}
}{
\matchingGrid
}
% ... (попередній код)
...
\begin{multicols}{3}\noindent
\noindent\textbf{15.}~Б \ {\scriptsize\color{gray}(19.06, №13)}\par
\noindent\textbf{37.}~$1{,}5$ \ {\scriptsize\color{gray}(30.05, №19)}\par
\noindent\textbf{38.}~$5$ \ {\scriptsize\color{gray}(3.06, №19)}\par
\noindent\textbf{39.}~$-0{,}035$ \ {\scriptsize\color{gray}(5.06, №20)}\par
\noindent\textbf{41.}~$20$ \ {\scriptsize\color{gray}(15.06, №19)}\par
\noindent\textbf{42.}~$54$ \ {\scriptsize\color{gray}(16.06, №19)}\par
\noindent\textbf{43.}~$-24$ \ {\scriptsize\color{gray}(18.06, №19)}\par
\end{multicols}
\fi
