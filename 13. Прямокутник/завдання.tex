...
\noindent{\small\color{gray!80} Розділ 4. Планіметрія \quad\textbullet\quad Усього завдань: 48 (НМТ \mbox{2023~--- 9}, \mbox{2024~--- 11}, \mbox{2025~--- 15}, \mbox{2026~--- 13}).}\par\vspace{0.2cm}
...
\matchingLayout{
    \textit{Фігура} \par\par\vspace{0.2cm}
    \textbf{1} \quad прямокутник $ABCD$ \\
    \textbf{2} \quad паралелограм $DKLM$ \\
    \textbf{3} \quad трикутник $LPQ$
}{
    \textit{Периметр фігури} \par\par\vspace{0.2cm}
    \begin{tabular}{ll}
    \textbf{А} & 24 \textit{см} \\
    \textbf{Б} & 32 \textit{см} \\
    \textbf{В} & 28 \textit{см} \\
...
\matchingLayout{
    ...
    \textit{Площа фігури} \par\par\vspace{0.2cm}
    \begin{tabular}{ll}
...
\begin{multicols}{3}\noindent
\noindent\textbf{36.}~А \ {\scriptsize\color{gray}(23.05, №13)}\par
\noindent\textbf{37.}~Г \ {\scriptsize\color{gray}(30.05, №15)}\par
\noindent\textbf{38.}~1~--~Г, 2~--~Б, 3~--~В \ {\scriptsize\color{gray}(2.06, №18)}\par
\noindent\textbf{39.}~В \ {\scriptsize\color{gray}(3.06, №14)}\par
\noindent\textbf{40.}~1~--~Г, 2~--~В, 3~--~А \ {\scriptsize\color{gray}(3.06, №18)}\par
\noindent\textbf{41.}~Д \ {\scriptsize\color{gray}(5.06, №14)}\par
\noindent\textbf{46.}~1--Б, 2--А, 3--Г \ {\scriptsize\color{gray}(15.06, №18)}\par
\noindent\textbf{47.}~1--А; 2--Г; 3--Д \ {\scriptsize\color{gray}(16.06, №18)}\par
\noindent\textbf{48.}~Г \ {\scriptsize\color{gray}(19.06, №14)}\par
\end{multicols}
\fi
