...
\noindent{\small\color{gray!80} Розділ 5. Стереометрія \quad\textbullet\quad Усього завдань: 69 (НМТ \mbox{2023~--- 14}, \mbox{2024~--- 20}, \mbox{2025~--- 16}, \mbox{2026~--- 19}).}\par\vspace{0.2cm}
...
\nopagebreak\vspace{-0.3cm} % Коригування для вирівнювання графіка з текстом
\begin{center}
