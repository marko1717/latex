...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2022--2026 \textendash{} Тема 18}
...
\noindent{\small\color{gray!80} Розділ 5. Стереометрія \quad\textbullet\quad Усього завдань: 67 (НМТ \mbox{2023~--- 14}, \mbox{2024~--- 18}, \mbox{2025~--- 16}, \mbox{2026~--- 19}); \mbox{тестових~--- 50}; \mbox{з короткою відповіддю~--- 17}.}\par\vspace{0.2cm}
...
\nmtnobreak
\nopagebreak\nbvspace{0.3cm}
\answerTable{$10{,}5$}{$21$}{$18$}{$3\sqrt{85}$}{$1{,}5\sqrt{85}$}
\par\penalty-20
\end{samepage}
...
\begin{multicols}{3}\noindent
\noindent\textbf{32.}~В \ {\scriptsize\color{gray}(23.05, №8)}\par
\noindent\textbf{33.}~Б \ {\scriptsize\color{gray}(30.05, №10)}\par
\noindent\textbf{34.}~В \ {\scriptsize\color{gray}(1.06, №15)}\par
\noindent\textbf{35.}~Г \ {\scriptsize\color{gray}(2.06, №12)}\par
\noindent\textbf{36.}~Г \ {\scriptsize\color{gray}(3.06, №12)}\par
\noindent\textbf{37.}~А \ {\scriptsize\color{gray}(4.06, №12)}\par
\noindent\textbf{38.}~А \ {\scriptsize\color{gray}(5.06, №7)}\par
\noindent\textbf{39.}~В \ {\scriptsize\color{gray}(5.06, №12)}\par
\noindent\textbf{46.}~Д \ {\scriptsize\color{gray}(15.06, №12)}\par
\noindent\textbf{47.}~Б \ {\scriptsize\color{gray}(16.06, №12)}\par
\noindent\textbf{48.}~Д \ {\scriptsize\color{gray}(17.06, №12)}\par
\noindent\textbf{49.}~А \ {\scriptsize\color{gray}(18.06, №12)}\par
\noindent\textbf{50.}~В \ {\scriptsize\color{gray}(19.06, №12)}\par
\end{multicols}
\fi
