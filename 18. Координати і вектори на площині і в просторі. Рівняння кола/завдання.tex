...
\noindent{\small\color{gray!80} Розділ 5. Стереометрія \quad\textbullet\quad Усього завдань: 67 (НМТ 2023~--- 14, 2024~--- 18, 2025~--- 16, 2026~--- 19).}\par\vspace{0.2cm}
...
\vspace{0.3cm}
\answerTable{$y=-2x$}{$y=8+2x$}{$y=4-2x$}{$y=2x$}{$y=-\dfrac{x}{2}$}
