...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2023--2026 \textendash{} Тема 21}
...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 108 (НМТ \mbox{2023~--- 29}, \mbox{2024~--- 33}, \mbox{2025~--- 28}, \mbox{2026~--- 18}).}\par\vspace{0.2cm}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.75]
        ...
        \fill (-3,-2) circle (3pt);
        \fill (3,2) circle (3pt);
        \node[fill=white, inner sep=1.5pt, left] at (-1, 1.8) {$y=f(x)$};
...
\hfill
\begin{minipage}[t]{0.50\textwidth}
    \textit{Найменше значення функції на відрізку $[0; 4]$} \par\par\vspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} p{7.5cm}@{}}
    \textbf{А} & $1$ \\[0.3cm]
    \textbf{Б} & $2$ \\[0.3cm]
    \textbf{В} & $3$ \\[0.3cm]
...
\hfill
\begin{minipage}[t]{0.50\textwidth}
    \textit{Найбільше значення функції на відрізку $[-1; 3]$} \par\par\vspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} p{7.5cm}@{}}
    \textbf{А} & $1$ \\[0.3cm]
    \textbf{Б} & $2$ \\[0.3cm]
    \textbf{В} & $3$ \\[0.3cm]
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \node[fill=white, inner sep=1.5pt, above right] at (-1,3) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \node[fill=white, inner sep=1.5pt, above right] at (2,1) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\matchingLayout{
    ...
    \textit{К-сть спільних точок} \par\par\vspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} l@{}}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \node[fill=white, inner sep=1.5pt, above right] at (2,2.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (-4,6) circle (3pt);
        \fill (6,1) circle (3pt);
        \node[fill=white, inner sep=1.5pt, above right] at (4,3) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.6]
        ...
        \node[fill=white, inner sep=1.5pt, below right] at (2,-1.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.6]
        ...
        \node[fill=white, inner sep=1.5pt, left] at (-1, 1.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\hfill
\begin{minipage}[t]{0.40\textwidth}
    \nopagebreak\vspace{-0.3cm} % Підтягуємо графік трохи вгору
    \begin{flushright}
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        % Сітка та осі
...
\hfill
\begin{minipage}[t]{0.40\textwidth}
    \nopagebreak\vspace{0.5cm} % Вирівнювання таблички по висоті
    \begin{flushright}
    % Табличка
    \begingroup
    \setlength{\tabcolsep}{4pt}
...
\begin{minipage}[t]{0.40\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (1,5) circle (3pt);
        \fill (9,1) circle (3pt);
        \node[fill=white, inner sep=1.5pt, above] at (3, 7) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (5, 1) circle (3pt);
        \node[fill=white, inner sep=1.5pt, above] at (-2, 3) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.6]
        ...
        \fill (-4, -2) circle (3pt);
        \fill (3, 1) circle (3pt);
        \node[fill=white, inner sep=1.5pt, above left] at (-1, 1.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (-5,-2) circle (3pt);
        \fill (4,5) circle (3pt);
        \node[fill=white, inner sep=1.5pt, left] at (-2, 2.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.6]
        ...
        \fill (-3, -1) circle (3pt);
        \fill (3, 2) circle (3pt);
        \node[fill=white, inner sep=1.5pt, left] at (-1.5, 1.5) {$y=f(x)$};
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (-5,6) circle (3pt);
        \fill (5,7) circle (3pt);
        \node[fill=white, inner sep=1.5pt, left] at (-1, 3.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (-5,-3) circle (3pt);
        \fill (5,6) circle (3pt);
        \node[fill=white, inner sep=1.5pt, right] at (2, 4.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\hfill
\begin{minipage}[t]{0.50\textwidth}
    \textit{Властивість функції} \par\par\vspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} p{6.2cm}@{}}
...
\hfill
\begin{minipage}[t]{0.30\textwidth}
    \textit{Координатні чверті} \par\par\vspace{0.2cm}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \node[fill=white, inner sep=1.5pt, right] at (2.5, 4.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.6]
        ...
        \fill (-2, 1) circle (3pt);
        \fill (4, -2) circle (3pt);
        \node[fill=white, inner sep=1.5pt, right] at (2, 1) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (-5,-2) circle (3pt);
        \fill (5,5) circle (3pt);
        \node[fill=white, inner sep=1.5pt, right] at (2, 3.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{nmtfit}\begin{tikzpicture}[scale=0.45, thick]
    ...
    \node[fill=white, inner sep=1.5pt, font=\tiny, mainGreen] at (3.5,4) {$y=f(x)$};
\end{tikzpicture}\end{nmtfit}
\end{minipage}
\par\vspace{0.2cm}
...
\begin{nmtfit}\begin{tikzpicture}[scale=0.42, thick]
    ...
    \node[fill=white, inner sep=1.5pt, right, font=\scriptsize] at (1.5,1.8) {$y=f(x)$};
\end{tikzpicture}\end{nmtfit}
\end{minipage}
\par\vspace{0.2cm}
...
\begin{nmtfit}\begin{tikzpicture}[scale=0.55, thick]
    ...
    \node[fill=white, inner sep=1.5pt, right, font=\scriptsize] at (2,2.3) {$y=f(x)$};
\end{tikzpicture}\end{nmtfit}
\end{center}
\nopagebreak\vspace{0.2cm}
\noindent
...
\begin{multicols}{3}\noindent
\noindent\textbf{91.}~А \ {\scriptsize\color{gray}(23.05, №4)}\par
\noindent\textbf{92.}~Б \ {\scriptsize\color{gray}(30.05, №8)}\par
\noindent\textbf{93.}~Д \ {\scriptsize\color{gray}(1.06, №8)}\par
\noindent\textbf{94.}~1~--~В, 2~--~Г, 3~--~А \ {\scriptsize\color{gray}(1.06, №17)}\par
\noindent\textbf{95.}~1~--~В, 2~--~Б, 3~--~А \ {\scriptsize\color{gray}(2.06, №17)}\par
\noindent\textbf{96.}~В \ {\scriptsize\color{gray}(3.06, №8)}\par
\noindent\textbf{97.}~1~--~Б, 2~--~А, 3~--~В \ {\scriptsize\color{gray}(3.06, №17)}\par
\noindent\textbf{98.}~А \ {\scriptsize\color{gray}(5.06, №8)}\par
\noindent\textbf{103.}~1--Б, 2--А, 3--Г \ {\scriptsize\color{gray}(15.06, №17)}\par
\noindent\textbf{104.}~1--Г; 2--В; 3--А \ {\scriptsize\color{gray}(16.06, №17)}\par
\noindent\textbf{105.}~1--В, 2--Г, 3--Д \ {\scriptsize\color{gray}(17.06, №17)}\par
\noindent\textbf{106.}~Г \ {\scriptsize\color{gray}(18.06, №8)}\par
\noindent\textbf{107.}~1--В,\ \ 2--Д,\ \ 3--Г \ {\scriptsize\color{gray}(18.06, №17)}\par
\noindent\textbf{108.}~1--А,\ \ 2--Г,\ \ 3--Б \ {\scriptsize\color{gray}(19.06, №17)}\par
\end{multicols}
\fi
