...
\noindent{\small\color{gray!80} Розділ 6. Комбінаторика, теорія ймовірності, статистика \quad\textbullet\quad Усього завдань: 37 (НМТ \mbox{2023~--- 19}, \mbox{2024~--- 2}, \mbox{2025~--- 6}, \mbox{2026~--- 10}); \mbox{тестових~--- 13}; \mbox{з короткою відповіддю~--- 24}.}\par\vspace{0.2cm}
...
\nopagebreak\nbvspace{-0.3cm} % Піднімаємо літак трохи вище
\begin{center}
...
\nopagebreak\nbvspace{-0.3cm}
\begin{center}
\begin{nmtfit}\begin{tikzpicture}[scale=1.2, line width=1pt]
...
\centering
\begin{nmtfit}\begin{tikzpicture}[scale=0.85, thick, line join=round, font=\sffamily]
...
\nopagebreak\nbvspace{-0.3cm}
\begin{center}
\begin{nmtfit}\begin{tikzpicture}[scale=0.8, transform shape]
    % Стилі
    \tikzset{
...
\begin{multicols}{3}\noindent
\noindent\textbf{4.}~Б \ {\scriptsize\color{gray}(23.05, №12)}\par
\noindent\textbf{5.}~Г \ {\scriptsize\color{gray}(30.05, №7)}\par
\noindent\textbf{6.}~Б \ {\scriptsize\color{gray}(1.06, №6)}\par
\noindent\textbf{7.}~А \ {\scriptsize\color{gray}(2.06, №7)}\par
\noindent\textbf{8.}~Г \ {\scriptsize\color{gray}(4.06, №11)}\par
\noindent\textbf{11.}~А \ {\scriptsize\color{gray}(16.06, №11)}\par
\noindent\textbf{12.}~Б \ {\scriptsize\color{gray}(17.06, №11)}\par
\noindent\textbf{13.}~Г \ {\scriptsize\color{gray}(19.06, №11)}\par
\end{multicols}
\fi
