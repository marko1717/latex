...
\noindent{\small\color{gray!80} Розділ 6. Комбінаторика, теорія ймовірності, статистика \quad\textbullet\quad Усього завдань: 37 (НМТ \mbox{2023~--- 19}, \mbox{2024~--- 2}, \mbox{2025~--- 6}, \mbox{2026~--- 10}).}\par\vspace{0.2cm}
...
\hfill
\begin{minipage}[t]{0.40\textwidth}
\nopagebreak\vspace{-0.3cm} % Піднімаємо літак трохи вище
\begin{center}
...
\begin{multicols}{3}\noindent
\noindent\textbf{28.}~Б \ {\scriptsize\color{gray}(23.05, №12)}\par
\noindent\textbf{29.}~Г \ {\scriptsize\color{gray}(30.05, №7)}\par
\noindent\textbf{30.}~Б \ {\scriptsize\color{gray}(1.06, №6)}\par
\noindent\textbf{31.}~А \ {\scriptsize\color{gray}(2.06, №7)}\par
\noindent\textbf{32.}~Г \ {\scriptsize\color{gray}(4.06, №11)}\par
\noindent\textbf{35.}~А \ {\scriptsize\color{gray}(16.06, №11)}\par
\noindent\textbf{36.}~Б \ {\scriptsize\color{gray}(17.06, №11)}\par
\noindent\textbf{37.}~Г \ {\scriptsize\color{gray}(19.06, №11)}\par
\end{multicols}
\fi
