...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 18 (НМТ \mbox{2023~--- 7}, \mbox{2024~--- 5}, \mbox{2025~--- 6}); \mbox{тестових~--- 1}; \mbox{на відповідність~--- 17}.}\par\vspace{0.2cm}
...
\begin{samepage}
% перенесено з теми 30a: завдання про графік або властивості функції
\noindent\zadnum Установіть відповідність між твердженням \mbox{(1--3)} та функцією \mbox{(А--Д)}, для якої це твердження є правильним. \nmtyear{2023}\par
\nopagebreak\nbvspace{0.3cm}
