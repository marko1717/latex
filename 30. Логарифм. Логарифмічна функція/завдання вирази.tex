...
\noindent{\small\color{gray!80} Розділ 1. Числа і вирази \quad\textbullet\quad Усього завдань: 75 (НМТ \mbox{2022~--- 1}, \mbox{2023~--- 19}, \mbox{2024~--- 27}, \mbox{2025~--- 19}, \mbox{2026~--- 9}); \mbox{тестових~--- 26}; \mbox{на відповідність~--- 49}.}\par\vspace{0.2cm}
...
\noindent\textbf{71.}~1~--~В, 2~--~Б, 3~--~Д \ {\scriptsize\color{gray}(30.05, №18)}\par
\noindent\textbf{72.}~1~--~Г, 2~--~А, 3~--~В \ {\scriptsize\color{gray}(1.06, №16)}\par
\noindent\textbf{73.}~1~--~А, 2~--~Г, 3~--~В \ {\scriptsize\color{gray}(2.06, №16)}\par
\noindent\textbf{74.}~1~--~В, 2~--~Г, 3~--~Б \ {\scriptsize\color{gray}(5.06, №16)}\par
\end{multicols}
\fi
