...
\answerTable{$(-3; 0]$}{$(0; 3]$}{$(7; +\infty)$}{$(-\infty; -3]$}{$(3; 7]$}

\vspace{0.5cm}

% Завдання 2
\task{2}{Розв'яжіть рівняння $x^2 - 12 = 4x - 12$. \nmtyear{2023}}
\answerTable{$2 - 2\sqrt{7}$; $2 + 2\sqrt{7}$}{$0$; $4$}{$-4$; $0$}{$-2$; $6$}{$-6$; $2$}

\vspace{0.5cm}

% Завдання 3
\task{3}{Розв'яжіть рівняння $(2x - 5)^2 = 0$. \nmtyear{2023}}
\answerTable{$-2{,}5$; $2{,}5$}{$2{,}5$}{$-2{,}5$}{$0{,}4$}{$-0{,}4$}
...
\answerTable{$[0; 4)$}{$(-\infty; -3)$}{$[-3; 0)$}{$[8; +\infty)$}{$[4; 8)$}
