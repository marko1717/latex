...
\fancyhead[C]{@pvtr2525 -- підготовка до НМТ з математики}
\fancyfoot[C]{@pvtr2525 -- підготовка до НМТ з математики}
...
% Клітинки для розв'язку (замість порожнього поля)
\newcommand{\solutionGrid}[1][3]{
\vspace{0.3cm}
\noindent
\begin{tikzpicture}
    \draw[step=0.5cm, gray!50, thin] (0,0) grid (\textwidth+0.2cm, #1*0.5cm);
\end{tikzpicture}
\vspace{0.3cm}
}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \draw[thick] (-3,-3) rectangle (6,4);  % <-- рамка
        \draw[step=1cm,black!50,very thin] (-3,-3) grid (6,4);
        \draw[->, >=stealth, thick] (-2.5,0) -- (5.5,0) node[below] {$x$};
...
% ЗАВДАННЯ 12
%======================================================================
\noindent\textbf{12.} \begin{minipage}[t]{0.5\textwidth}
...
\end{minipage}
\vspace{0.3cm}
\answerTable{$36\sqrt{3}$ \textit{см}}{$12$ \textit{см}}{$18$ \textit{см}}{$12\sqrt{3}$ \textit{см}}{$36$ \textit{см}}
...
\begin{minipage}[t]{0.4\textwidth}
   ...
   \begin{tikzpicture}[scale=0.2]
        ...
        % Позначки середин
        \draw[thick] ($(A)!0.5!(K)$) ++(90:1) -- ++(-90:2);
        \draw[thick] ($(K)!0.5!(D)$) ++(90:1) -- ++(-90:2);
        \draw[thick] ($(D)!0.5!(M)$) ++(90:1) -- ++(-90:2);
        \draw[thick] ($(M)!0.5!(C)$) ++(90:1) -- ++(-90:2);
...
\begin{minipage}[t]{0.40\textwidth}
    ...
    \begin{tikzpicture}[scale=0.55]
        \draw[step=1cm,gray!30,very thin] (-5.5,-7.5) grid (6.5,2.5);
        \draw[->, >=stealth, thick] (-5.5,0) -- (6.5,0) node[below] {$x$};
        \draw[->, >=stealth, thick] (0,-7.5) -- (0,2.5) node[left] {$y$};
        ...
        % Графік згідно PDF: починається з (-4, -6), зростає до (0, 1), спадає до (2, -5), потім зростає до (5, -1)
        \draw[thick] plot [smooth, tension=0.7] coordinates {(-4, -6) (-2, -3)(-1, 0) (0, 1)(1, 0) (2, -3)(3, -4) (5, -1)};
        \fill (-4,-6) circle (3pt);
        \fill (5, -1) circle (3pt);
        \node[right] at (4, -3) {\small $y=f(x)$};
    \end{tikzpicture}
    \end{flushright}
\end{minipage}
