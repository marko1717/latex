...
\task{9}{$|3 - \sqrt{11}| =$ \gen}
\answerTable{$3 - \sqrt{11}$}{$\sqrt{11} - 3$}{$3 + \sqrt{11}$}{$\sqrt{2}$}{$\sqrt{8}$}
% Відповідь: Г. √11≈3.32>3, тому |3-√11|=√11-3

\vspace{0.5cm}

\task{10}{$|4 - \sqrt{13}| =$ \gen}
\answerTable{$\sqrt{3}$}{$\sqrt{13} - 4$}{$\sqrt{9}$}{$4 - \sqrt{13}$}{$4 + \sqrt{13}$}
% Відповідь: Б. √13≈3.61<4, тому |4-√13|=4-√13

\vspace{0.5cm}

\task{11}{$|5 - \sqrt{30}| =$ \gen}
\answerTable{$5 - \sqrt{30}$}{$\sqrt{25}$}{$\sqrt{30} - 5$}{$\sqrt{5}$}{$5 + \sqrt{30}$}
...
\answerTable{$\sqrt{2}$}{$4 - \sqrt{18}$}{$\sqrt{18} + 4$}{$\sqrt{18} - 4$}{$-4 - \sqrt{18}$}
% Відповідь: Г. √18≈4.24>4, тому |√18-4|=√18-4

\vspace{0.5cm}

\task{14}{$|\sqrt{5} - 3| =$ \gen}
\answerTable{$-3 - \sqrt{5}$}{$3 - \sqrt{5}$}{$\sqrt{5} + 3$}{$\sqrt{4}$}{$\sqrt{5} - 3$}
...
\answerTable{$\sqrt{2}$}{$3\sqrt{2} + 5$}{$5 - 3\sqrt{2}$}{$-3\sqrt{2} - 5$}{$3\sqrt{2} - 5$}
% Відповідь: А. 3√2≈4.24<5, тому |3√2-5|=5-3√2

\vspace{0.5cm}

\task{16}{$|2\sqrt{3} - 4| =$ \gen}
\answerTable{$2\sqrt{3} + 4$}{$4 - 2\sqrt{3}$}{$2\sqrt{3} - 4$}{$\sqrt{3}$}{$-2\sqrt{3} - 4$}
% Відповідь: А. 2√3≈3.46<4, тому |2√3-4|=4-2√3

\vspace{0.5cm}

\task{17}{$|3\sqrt{3} - 6| =$ \gen}
\answerTable{$\sqrt{3}$}{$-3\sqrt{3} - 6$}{$6 - 3\sqrt{3}$}{$3\sqrt{3} - 6$}{$3\sqrt{3} + 6$}
...
\answerTable{$5$}{$23$}{$-5$}{$17$}{$-17$}
% Відповідь: Д. |3-20|=17

\vspace{0.5cm}

\task{19}{$|5 - 3 \cdot 7| =$ \gen}
\answerTable{$-11$}{$11$}{$-16$}{$16$}{$26$}
% Відповідь: Д. |5-21|=16

\vspace{0.5cm}

\task{20}{$|4 - 6 \cdot 3| =$ \gen}
\answerTable{$6$}{$-14$}{$-6$}{$14$}{$22$}
% Відповідь: Д. |4-18|=14
...
\answerTable{$-15{,}5$}{$11{,}5$}{$-11{,}5$}{$9{,}5$}{$15{,}5$}
% Відповідь: Г. |2-13.5|=11.5

\vspace{0.5cm}

\task{22}{$|3 - 5 \cdot 2{,}4| =$ \gen}
\answerTable{$-15$}{$15$}{$-9$}{$6$}{$9$}
% Відповідь: Г. |3-12|=9
...
\answerTable{$10$}{$4$}{$-4$}{$1$}{$-10$}
% Відповідь: В. |3-7|=4

\vspace{0.5cm}

\task{24}{$|5 - 90 \cdot 0{,}1| =$ \gen}
\answerTable{$-14$}{$1$}{$4$}{$14$}{$-4$}
% Відповідь: В. |5-9|=4

\vspace{0.5cm}

\task{25}{$|1 - 60 \cdot 0{,}1| =$ \gen}
\answerTable{$5$}{$7$}{$-7$}{$0{,}4$}{$-5$}
% Відповідь: В. |1-6|=5
...
\answerTableBig{$\dfrac{4}{3}$}{$\dfrac{9}{4}$}{$-\dfrac{1}{3}$}{$\dfrac{1}{3}$}{$-\dfrac{4}{3}$}
% Відповідь: Г. |3·(-4/9)|=|-4/3|=4/3

\vspace{0.5cm}

\task{27}{Обчисліть $\left|4 \cdot \left(-\dfrac{3}{8}\right)\right|$. \gen}
\answerTableBig{$\dfrac{3}{2}$}{$-\dfrac{3}{2}$}{$-\dfrac{1}{2}$}{$\dfrac{1}{2}$}{$\dfrac{8}{3}$}
% Відповідь: Г. |4·(-3/8)|=|-3/2|=3/2

\vspace{0.5cm}

\task{28}{Обчисліть $\left|5 \cdot \left(-\dfrac{2}{15}\right)\right|$. \gen}
\answerTableBig{$-\dfrac{1}{3}$}{$-\dfrac{2}{3}$}{$\dfrac{2}{3}$}{$\dfrac{1}{3}$}{$\dfrac{15}{2}$}
...
\answerTableBig{$\dfrac{47}{12}$}{$-\dfrac{1}{3}$}{$-3$}{$\dfrac{3}{12}$}{$\dfrac{1}{3}$}
% Відповідь: Д. 4·(-1/12)=-4/12=-1/3

\vspace{0.5cm}

\task{30}{$5 \cdot \left(-\dfrac{1}{20}\right) =$ \gen}
\answerTableBig{$\dfrac{1}{4}$}{$\dfrac{4}{20}$}{$-4$}{$\dfrac{99}{20}$}{$-\dfrac{1}{4}$}
% Відповідь: Д. 5·(-1/20)=-5/20=-1/4

\vspace{0.5cm}

\task{31}{$6 \cdot \left(-\dfrac{1}{18}\right) =$ \gen}
\answerTableBig{$-\dfrac{1}{3}$}{$\dfrac{107}{18}$}{$-3$}{$\dfrac{5}{18}$}{$\dfrac{1}{3}$}
...
\answerTableBig{$2\dfrac{3}{4}$}{$\dfrac{3}{4}$}{$-12$}{$-\dfrac{1}{12}$}{$-\dfrac{3}{4}$}
% Відповідь: Д. 3·(-1/4)=-3/4

\vspace{0.5cm}

\task{33}{$4 \cdot \left(-\dfrac{1}{5}\right) =$ \gen}
\answerTableBig{$-\dfrac{4}{5}$}{$3\dfrac{4}{5}$}{$-20$}{$\dfrac{4}{5}$}{$-\dfrac{1}{20}$}
...
\answerTableBig{$1\dfrac{1}{2}$}{$\dfrac{3}{4}$}{$-\dfrac{1}{2}$}{$2\dfrac{1}{4}$}{$\dfrac{1}{2}$}
% Відповідь: А. |2·(5/4)-3|=|5/2-3|=|-1/2|=1/2

\vspace{0.5cm}

\task{38}{$\left|3 \cdot 1\dfrac{1}{6} - 4\right| =$ \gen}
\answerTableBig{$1\dfrac{1}{6}$}{$2\dfrac{1}{6}$}{$-\dfrac{1}{2}$}{$\dfrac{5}{6}$}{$\dfrac{1}{2}$}
...
\answerTable{$-3{,}3$}{$2{,}5$}{$0{,}3$}{$3{,}15$}{$3{,}3$}
% Відповідь: Д. |3.1-6.4|=3.3

\vspace{0.5cm}

\task{40}{$\left|1{,}7 - \dfrac{28}{5}\right| =$ \gen}
\answerTable{$-3{,}9$}{$0{,}4$}{$3{,}85$}{$3{,}9$}{$2{,}1$}
...
\task{41}{$|1 - 0{,}5^{-3}| =$ \gen}
\answerTable{$0{,}125$}{$9$}{$7$}{$0{,}875$}{$1{,}125$}
% Відповідь: А. |1-8|=7

\vspace{0.5cm}

\task{42}{$|1 - 0{,}25^{-1}| =$ \gen}
\answerTable{$3$}{$0{,}25$}{$0{,}75$}{$5$}{$1{,}25$}
% Відповідь: А. |1-4|=3

\vspace{0.5cm}

\task{43}{$|1 - 0{,}2^{-2}| =$ \gen}
\answerTable{$0{,}04$}{$1{,}04$}{$26$}{$0{,}96$}{$24$}
% Відповідь: А. |1-25|=24

\vspace{0.5cm}

\task{44}{$|2 - 0{,}5^{-2}| =$ \gen}
\answerTable{$2{,}25$}{$1{,}75$}{$2$}{$6$}{$0{,}25$}
% Відповідь: А. |2-4|=2
...
\answerTable{$31\,850$}{$3050$}{$3350$}{$2995$}{$170$}
% Відповідь: А. |3200-150|=3050

\vspace{0.5cm}

\task{46}{$|1{,}5 \cdot 10^3 - 80| =$ \gen}
\answerTable{$14\,920$}{$1420$}{$1580$}{$70$}{$1495$}
...
\task{47}{$4 : 0{,}4 =$ \gen}
\answerTableBig{$\dfrac{1}{16}$}{$1{,}6$}{$0{,}1$}{$10$}{$1{,}0$}
% Відповідь: Г. 4/0.4=10

\vspace{0.5cm}

\task{48}{$5 : 0{,}5 =$ \gen}
\answerTableBig{$0{,}1$}{$10$}{$2{,}5$}{$\dfrac{1}{25}$}{$1{,}0$}
% Відповідь: Г. 5/0.5=10

\vspace{0.5cm}

\task{49}{$6 : 0{,}2 =$ \gen}
\answerTableBig{$\dfrac{1}{12}$}{$3{,}0$}{$0{,}03$}{$1{,}2$}{$30$}
% Відповідь: Г. 6/0.2=30

\vspace{0.5cm}

\task{50}{$8 : 0{,}4 =$ \gen}
\answerTableBig{$20$}{$\dfrac{1}{20}$}{$3{,}2$}{$2{,}0$}{$0{,}05$}
