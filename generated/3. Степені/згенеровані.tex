...
\answerTableBig{$2$}{$\dfrac{1}{2}$}{$\dfrac{3}{2}$}{$\dfrac{2}{3}$}{$1$}
% Відповідь: А (3^4 * 2^5 / (2^4 * 3^4) = 2)

\vspace{0.5cm}

\task{6}{$\dfrac{7^3 \cdot 3^4}{21^3} =$ \nmtyear{gen}}
\answerTableBig{$3$}{$7$}{$\dfrac{1}{3}$}{$21$}{$\dfrac{7}{3}$}
% Відповідь: А (7^3 * 3^4 / (7^3 * 3^3) = 3)

\vspace{0.5cm}

\task{7}{$\dfrac{2^6 \cdot 3^5}{6^5} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{1}{3}$}{$\dfrac{2}{3}$}{$2$}{$\dfrac{3}{2}$}{$3$}
...
\answerTableBig{$\dfrac{1}{21}$}{$\dfrac{1}{63}$}{$\dfrac{1}{7}$}{$\dfrac{3}{7}$}{$\dfrac{7}{3}$}
...
\answerTableBig{$\dfrac{1}{50}$}{$\dfrac{1}{20}$}{$\dfrac{1}{8}$}{$\dfrac{5}{4}$}{$\dfrac{1}{4}$}
...
\answerTableBig{$14$}{$\dfrac{7}{4}$}{$\dfrac{7}{2}$}{$\dfrac{2}{7}$}{$\dfrac{14}{7}$}
...
\answerTable{$7xy^3$}{$10x^2y^6$}{$10xy^6$}{$7x^2y^6$}{$10xy^9$}
% Відповідь: Б

\vspace{0.5cm}

\task{12}{Спростіть вираз $3a^2b \cdot 4ab^2$. \nmtyear{gen}}
\answerTable{$12a^3b^3$}{$7a^3b^3$}{$12a^2b^2$}{$7a^2b^2$}{$12ab$}
% Відповідь: А
...
\answerTable{$36m^8$}{$13m^8$}{$36m^{16}$}{$13m^{16}$}{$36m^4$}
% Відповідь: А

\vspace{0.5cm}

\task{14}{$6x^5 \cdot 5x^3 =$ \nmtyear{gen}}
\answerTable{$30x^8$}{$11x^8$}{$30x^{15}$}{$11x^{15}$}{$30x^2$}
% Відповідь: А
...
\answerTable{$30b^7$}{$11b^7$}{$30b^{12}$}{$30b^1$}{$11b^{12}$}
% Відповідь: А
...
\answerTable{$-2x^5$}{$-0{,}2x^5$}{$2x^5$}{$-0{,}2x^6$}{$-2x^6$}
% Відповідь: А

\vspace{0.5cm}

\task{17}{$0{,}25y^4 \cdot (-8y^3) =$ \nmtyear{gen}}
\answerTable{$-2y^7$}{$-0{,}2y^7$}{$2y^7$}{$-2y^{12}$}{$-0{,}2y^{12}$}
% Відповідь: А
...
\answerTable{$3a^7$}{$0{,}3a^7$}{$15{,}2a^7$}{$3a^{12}$}{$0{,}3a^{12}$}
% Відповідь: А
...
\answerTable{$4x^7$}{$40x^7$}{$4x^{10}$}{$0{,}4x^7$}{$0{,}4x^{10}$}
% Відповідь: А
...
\task{21}{$(-3x^3)^3 =$ \nmtyear{gen}}
\answerTable{$-9x^6$}{$-27x^9$}{$-3x^9$}{$-27x^6$}{$-9x^9$}
% Відповідь: Б

\vspace{0.5cm}

\task{22}{$(-4y^2)^3 =$ \nmtyear{gen}}
\answerTable{$-64y^6$}{$-12y^6$}{$-4y^6$}{$-64y^8$}{$-12y^8$}
% Відповідь: А
...
\task{23}{$(-3x^4)^2 =$ \nmtyear{gen}}
\answerTable{$9x^8$}{$-9x^8$}{$6x^8$}{$9x^6$}{$-6x^6$}
% Відповідь: А

\vspace{0.5cm}

\task{24}{$(-5a^3)^2 =$ \nmtyear{gen}}
\answerTable{$25a^6$}{$-25a^6$}{$10a^6$}{$25a^5$}{$-10a^5$}
% Відповідь: А
...
\task{25}{$(-4x^2)^3 =$ \nmtyear{gen}}
\answerTable{$-12x^5$}{$64x^6$}{$-64x^6$}{$-12x^6$}{$64x^5$}
% Відповідь: В
...
\answerTableBig{$\dfrac{9}{16}a^{8}$}{$\dfrac{6}{8}a^{8}$}{$\dfrac{9}{16}a^{6}$}{$\dfrac{6}{16}a^{6}$}{$\dfrac{9}{8}a^{8}$}
% Відповідь: А

\vspace{0.5cm}

\task{27}{$\left(\dfrac{2}{5}b^3\right)^3 =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{8}{125}b^{9}$}{$\dfrac{6}{15}b^{9}$}{$\dfrac{8}{125}b^{6}$}{$\dfrac{6}{125}b^{6}$}{$\dfrac{8}{15}b^{9}$}
% Відповідь: А
...
\answerTable{$x^{9}$}{$x^{15}$}{$x^{12}$}{$x^{-1}$}{$x^{6}$}
% Відповідь: Б (x^12 / x^-3 = x^15)

\vspace{0.5cm}

\task{29}{$\dfrac{(a^3)^4}{a^{-2}} =$ \nmtyear{gen}}
\answerTable{$a^{10}$}{$a^{14}$}{$a^{12}$}{$a^{-2}$}{$a^{6}$}
...
\answerTable{$x^{3}$}{$x^{7}$}{$x^{13}$}{$x^{-1}$}{$x^{5}$}
% Відповідь: Б (x^3 / x^-4 = x^7)

\vspace{0.5cm}

\task{31}{$\dfrac{y^8 \cdot y^{-5}}{y^{-2}} =$ \nmtyear{gen}}
\answerTable{$y^{1}$}{$y^{5}$}{$y^{11}$}{$y^{-5}$}{$y^{3}$}
...
\answerTableBig{$\dfrac{1}{x^2}$}{$\dfrac{1}{x^3}$}{$\dfrac{3}{x^2}$}{$\dfrac{1}{3x^2}$}{$\dfrac{x^2}{9}$}
% Відповідь: А (9x^6 / 9x^8 = 1/x^2)

\vspace{0.5cm}

\task{33}{Спростіть вираз $\dfrac{(4y^2)^3}{8y^{10}}$. \nmtyear{gen}}
\answerTableBig{$\dfrac{8}{y^4}$}{$\dfrac{4}{y^4}$}{$\dfrac{2}{y^4}$}{$\dfrac{8}{y^2}$}{$\dfrac{4}{y^2}$}
...
\answerTable{$(-\infty; -10]$}{$(-10; 0]$}{$(0; 10]$}{$(10; 30]$}{$(30; +\infty)$}
% Відповідь: Г (3^3 = 27)

\vspace{0.5cm}

\task{35}{Укажіть проміжок, якому належить значення виразу $\left(\dfrac{1}{5}\right)^{-2}$. \nmtyear{gen}}
\answerTable{$(-\infty; 0]$}{$(0; 10]$}{$(10; 30]$}{$(30; 50]$}{$(50; +\infty)$}
% Відповідь: В (5^2 = 25)
...
\answerTableBig{$\dfrac{4}{3}$}{$\dfrac{1}{3}$}{$\dfrac{3}{4}$}{$1$}{$-1\dfrac{1}{3}$}
% Відповідь: В (4/3)^-1 = 3/4

\vspace{0.5cm}

\task{37}{$\left(2\dfrac{1}{2}\right)^{-1} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{5}{2}$}{$\dfrac{1}{2}$}{$\dfrac{2}{5}$}{$1$}{$-2\dfrac{1}{2}$}
...
\answerTableBig{$\dfrac{1}{3}$}{$3$}{$0{,}3$}{$0{,}03$}{$-3$}
% Відповідь: А (3^-1 = 1/3)
...
\answerTable{$4{,}5$}{$12{,}25$}{$7$}{$14$}{$24{,}5$}
% Відповідь: Б (49/4 = 12.25)

\vspace{0.5cm}

\task{41}{$\left(\dfrac{3}{4}\right)^2 =$ \nmtyear{gen}}
\answerTable{$0{,}375$}{$0{,}5625$}{$0{,}75$}{$1{,}5$}{$0{,}1875$}
% Відповідь: Б (9/16 = 0.5625)

\vspace{0.5cm}

\task{42}{$\left(\dfrac{9}{4}\right)^2 =$ \nmtyear{gen}}
\answerTableBig{$2{,}25$}{$5{,}0625$}{$4{,}5$}{$\dfrac{81}{8}$}{$\dfrac{9}{2}$}
...
\answerTable{$7245 \cdot 10^4$}{$7{,}245 \cdot 10^{-7}$}{$7{,}245 \cdot 10^{7}$}{$72{,}45 \cdot 10^{6}$}{$724{,}5 \cdot 10^{5}$}
% Відповідь: В

\vspace{0.5cm}

\task{44}{Запишіть число 156 млн 800 тис. у стандартному вигляді. \nmtyear{gen}}
\answerTable{$1568 \cdot 10^5$}{$1{,}568 \cdot 10^{-8}$}{$1{,}568 \cdot 10^{8}$}{$15{,}68 \cdot 10^{7}$}{$156{,}8 \cdot 10^{6}$}
% Відповідь: В
...
\answerTable{$27{,}5 \cdot 10^{7}$}{$27{,}5 \cdot 10^{-7}$}{$2{,}75 \cdot 10^{7}$}{$275 \cdot 10^{5}$}{$0{,}275 \cdot 10^{7}$}
% Відповідь: В
...
\answerTable{$2^{24}$}{$2^{21}$}{$32^{20}$}{$2^{320}$}{$2^{80}$}
...
\answerTable{$9{,}1 \cdot 10^{-34}$ кг}{$9{,}1 \cdot 10^{-28}$ кг}{$9{,}1 \cdot 10^{-27}$ кг}{$9{,}1 \cdot 10^{-30}$ кг}{$91 \cdot 10^{-28}$ кг}
...
\answerTable{$3{,}3 \cdot 10^{25}$}{$3{,}3 \cdot 10^{19}$}{$3{,}3 \cdot 10^{22}$}{$3{,}3 \cdot 10^{28}$}{$3300 \cdot 10^{25}$}
...
\answerTable{$7{,}35 \cdot 10^{24}$ кг}{$7{,}35 \cdot 10^{20}$ кг}{$7{,}35 \cdot 10^{19}$ кг}{$73{,}5 \cdot 10^{21}$ кг}{$7{,}35 \cdot 10^{21}$ кг}
% Відповідь: Б
...
\answerTable{$3 \cdot 10^{-3}$ кг}{$3 \cdot 10^{-2}$ кг}{$3 \cdot 10^{-4}$ кг}{$1{,}5 \cdot 10^{-3}$ кг}{$1{,}5 \cdot 10^{-4}$ кг}
...
\answerTable{$1{,}5 \cdot 10^5$ кг}{$1{,}5 \cdot 10^6$ кг}{$7{,}5 \cdot 10^5$ кг}{$7{,}5 \cdot 10^6$ кг}{$2{,}5 \cdot 10^4$ кг}
...
\answerTable{$3 \cdot 10^{11}$ м/с}{$3 \cdot 10^{5}$ м/с}{$3 \cdot 0{,}01^{8}$ м/с}{$3 \cdot 10^{0{,}008}$ м/с}{$3 \cdot 10^{4}$ м/с}
...
\answerTable{$b^{48}$}{$b^{13}$}{$b^{14}$}{$b^{24}$}{$b^{11}$}
% Відповідь: В (b^8 * b^6 = b^14)

\vspace{0.5cm}

\task{56}{Спростіть вираз $a^5 \cdot (a^4)^2$. \nmtyear{gen}}
\answerTable{$a^{40}$}{$a^{11}$}{$a^{13}$}{$a^{18}$}{$a^{9}$}
...
\task{59}{$2^{80} =$ \nmtyear{gen}}
\answerTableBig{$2^{8} \cdot 2^{10}$}{$\dfrac{2^{800}}{2^{10}}$}{$2^{40} + 2^{40}$}{$(2^{8})^{10}$}{$(2^{40})^{40}$}
% Відповідь: Г (2^8)^10 = 2^80

\vspace{0.5cm}

\task{60}{$5^{60} =$ \nmtyear{gen}}
\answerTableBig{$5^{6} \cdot 5^{10}$}{$\dfrac{5^{600}}{5^{10}}$}{$5^{30} + 5^{30}$}{$(5^{6})^{10}$}{$(5^{30})^{30}$}
...
\answerTable{$3^{4-x^2}$}{$6$}{$9^{4-x^2}$}{$81$}{$9$}
% Відповідь: Г (3^(2+x+2-x) = 3^4 = 81)

\vspace{0.5cm}

\task{62}{Спростіть вираз $2^{3+y} \cdot 2^{3-y}$. \nmtyear{gen}}
\answerTable{$2^{9-y^2}$}{$12$}{$4^{9-y^2}$}{$64$}{$8$}
% Відповідь: Г (2^6 = 64)
...
\answerTableBig{$\dfrac{7}{8}x^2$}{$\dfrac{3}{8}x^{-2}$}{$\dfrac{3}{2}x^{-2}$}{$\dfrac{3}{2}x$}{$\dfrac{3}{2}x^2$}
% Відповідь: Д (3/8 * 4 * x^2 = 3/2 * x^2)

\vspace{0.5cm}

\task{64}{$\dfrac{4}{9}y^{-4} \cdot 3y^6 =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{7}{9}y^2$}{$\dfrac{4}{9}y^{-2}$}{$\dfrac{4}{3}y^{-2}$}{$\dfrac{4}{3}y$}{$\dfrac{4}{3}y^2$}
...
\answerTableBig{$0{,}0125$}{$0{,}125$}{$\dfrac{1}{256}$}{$1{,}25$}{$12{,}5$}
% Відповідь: Б
...
\answerTableBig{$\dfrac{b^{-4{,}5}}{4}$}{$\dfrac{b^2}{4}$}{$\dfrac{1}{4b^{16}}$}{$\dfrac{b^2}{2}$}{$\dfrac{b^5}{4}$}
% Відповідь: Б (b^12 / 4b^10 = b^2/4)

\vspace{0.5cm}

\task{69}{$\dfrac{c^{20}c^{-6}}{(3c^6)^2} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{c^{-6}}{6}$}{$\dfrac{c^2}{9}$}{$\dfrac{1}{9c^{18}}$}{$\dfrac{c^2}{6}$}{$\dfrac{c^5}{9}$}
...
\answerTable{$125$}{$250$}{$625$}{$500$}{$1250$}
...
\answerTableBig{$3$}{$\dfrac{1}{3}$}{$\dfrac{4}{3}$}{$\dfrac{3}{4}$}{$1$}
% Відповідь: А

\vspace{0.5cm}

\task{87}{$\dfrac{5^4 \cdot 2^6}{10^5} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{1}{5}$}{$\dfrac{2}{5}$}{$\dfrac{1}{2}$}{$2$}{$5$}
% Відповідь: А (5^4 * 2^6 / (5^5 * 2^5) = 2/5)

\vspace{0.5cm}

\task{88}{$\dfrac{6^8 \cdot 5^7}{30^8} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{1}{5}$}{$\dfrac{1}{6}$}{$\dfrac{5}{6}$}{$\dfrac{6}{5}$}{$1$}
% Відповідь: А

\vspace{0.5cm}

\task{89}{$\dfrac{9^6 \cdot 4^5}{36^6} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{1}{4}$}{$\dfrac{1}{9}$}{$\dfrac{4}{9}$}{$\dfrac{9}{4}$}{$1$}
% Відповідь: А

\vspace{0.5cm}

\task{90}{$\dfrac{8^4 \cdot 5^5}{40^5} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{1}{5}$}{$\dfrac{1}{8}$}{$\dfrac{5}{8}$}{$\dfrac{8}{5}$}{$1$}
...
\answerTable{$24p^8$}{$11p^8$}{$24p^{15}$}{$11p^{15}$}{$24p^3$}
% Відповідь: А

\vspace{0.5cm}

\task{92}{$7q^4 \cdot 6q^2 =$ \nmtyear{gen}}
\answerTable{$42q^6$}{$13q^6$}{$42q^8$}{$13q^8$}{$42q^2$}
% Відповідь: А

\vspace{0.5cm}

\task{93}{Спростіть вираз $4xy^4 \cdot 3x^2y$. \nmtyear{gen}}
\answerTable{$12x^3y^5$}{$7x^3y^5$}{$12x^2y^4$}{$7x^2y^4$}{$12xy$}
% Відповідь: А

\vspace{0.5cm}

\task{94}{Спростіть вираз $6a^3b^2 \cdot 2a^2b^3$. \nmtyear{gen}}
\answerTable{$12a^5b^5$}{$8a^5b^5$}{$12a^6b^6$}{$8a^6b^6$}{$12ab$}
% Відповідь: А

\vspace{0.5cm}

\task{95}{$5m^2n^3 \cdot 4mn^2 =$ \nmtyear{gen}}
\answerTable{$20m^3n^5$}{$9m^3n^5$}{$20m^2n^6$}{$9m^2n^6$}{$20mn$}
% Відповідь: А
...
\answerTable{$-3x^7$}{$-0{,}3x^7$}{$3x^7$}{$-3x^{12}$}{$-0{,}3x^{12}$}
% Відповідь: А

\vspace{0.5cm}

\task{97}{$0{,}125y^5 \cdot (-16y^2) =$ \nmtyear{gen}}
\answerTable{$-2y^7$}{$-0{,}2y^7$}{$2y^7$}{$-2y^{10}$}{$-0{,}2y^{10}$}
% Відповідь: А

\vspace{0.5cm}

\task{98}{Спростіть вираз $0{,}7a^2 \cdot 10a^3$. \nmtyear{gen}}
\answerTable{$7a^5$}{$0{,}7a^5$}{$70a^5$}{$7a^6$}{$0{,}7a^6$}
% Відповідь: А

\vspace{0.5cm}

\task{99}{$0{,}15b^3 \cdot 20b^4 =$ \nmtyear{gen}}
\answerTable{$3b^7$}{$0{,}3b^7$}{$30b^7$}{$3b^{12}$}{$0{,}3b^{12}$}
% Відповідь: А

\vspace{0.5cm}

\task{100}{$1{,}5c^2 \cdot 4c^5 =$ \nmtyear{gen}}
\answerTable{$6c^7$}{$5{,}5c^7$}{$6c^{10}$}{$60c^7$}{$0{,}6c^7$}
% Відповідь: А
...
\task{101}{$(-5x^2)^3 =$ \nmtyear{gen}}
\answerTable{$-125x^6$}{$-15x^6$}{$-5x^6$}{$-125x^8$}{$-15x^8$}
% Відповідь: А

\vspace{0.5cm}

\task{102}{$(-2y^5)^4 =$ \nmtyear{gen}}
\answerTable{$16y^{20}$}{$-16y^{20}$}{$8y^{20}$}{$16y^9$}{$-8y^9$}
% Відповідь: А

\vspace{0.5cm}

\task{103}{$(-7a^3)^2 =$ \nmtyear{gen}}
\answerTable{$49a^6$}{$-49a^6$}{$14a^6$}{$49a^5$}{$-14a^5$}
% Відповідь: А

\vspace{0.5cm}

\task{104}{$\left(\dfrac{5}{6}x^3\right)^2 =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{25}{36}x^{6}$}{$\dfrac{10}{12}x^{6}$}{$\dfrac{25}{36}x^{5}$}{$\dfrac{10}{36}x^{5}$}{$\dfrac{25}{12}x^{6}$}
% Відповідь: А

\vspace{0.5cm}

\task{105}{$\left(\dfrac{3}{7}y^4\right)^2 =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{9}{49}y^{8}$}{$\dfrac{6}{14}y^{8}$}{$\dfrac{9}{49}y^{6}$}{$\dfrac{6}{49}y^{6}$}{$\dfrac{9}{14}y^{8}$}
% Відповідь: А
...
\answerTable{$a^{11}$}{$a^{19}$}{$a^{15}$}{$a^{-1}$}{$a^{8}$}
% Відповідь: Б (a^15 * a^4 = a^19)

\vspace{0.5cm}

\task{107}{$\dfrac{(b^4)^3}{b^{-5}} =$ \nmtyear{gen}}
\answerTable{$b^{7}$}{$b^{17}$}{$b^{12}$}{$b^{-2}$}{$b^{9}$}
% Відповідь: Б (b^12 * b^5 = b^17)

\vspace{0.5cm}

\task{108}{$\dfrac{x^7 \cdot x^{-2}}{x^{-3}} =$ \nmtyear{gen}}
\answerTable{$x^{2}$}{$x^{8}$}{$x^{12}$}{$x^{-2}$}{$x^{5}$}
% Відповідь: Б (x^5 * x^3 = x^8)

\vspace{0.5cm}

\task{109}{Спростіть вираз $\dfrac{(5y^4)^2}{25y^{12}}$. \nmtyear{gen}}
\answerTableBig{$\dfrac{1}{y^4}$}{$\dfrac{1}{y^2}$}{$\dfrac{5}{y^4}$}{$\dfrac{1}{5y^4}$}{$\dfrac{y^4}{25}$}
% Відповідь: А (25y^8 / 25y^12 = 1/y^4)

\vspace{0.5cm}

\task{110}{Спростіть вираз $\dfrac{(3z^2)^4}{9z^{12}}$. \nmtyear{gen}}
\answerTableBig{$\dfrac{9}{z^4}$}{$\dfrac{3}{z^4}$}{$\dfrac{1}{z^4}$}{$\dfrac{9}{z^2}$}{$\dfrac{3}{z^2}$}
...
\answerTable{$(-\infty; 0]$}{$(0; 16]$}{$(16; 32]$}{$(32; 64]$}{$(64; +\infty)$}
% Відповідь: В (2^5 = 32)

\vspace{0.5cm}

\task{112}{$\left(1\dfrac{1}{2}\right)^{-1} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{3}{2}$}{$\dfrac{1}{2}$}{$\dfrac{2}{3}$}{$1$}{$-1\dfrac{1}{2}$}
% Відповідь: В

\vspace{0.5cm}

\task{113}{$\left(3\dfrac{1}{3}\right)^{-1} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{10}{3}$}{$\dfrac{1}{3}$}{$\dfrac{3}{10}$}{$1$}{$-3\dfrac{1}{3}$}
% Відповідь: В
...
\answerTableBig{$\dfrac{1}{5}$}{$5$}{$0{,}2$}{$0{,}02$}{$-5$}
...
\answerTable{$4520 \cdot 10^4$}{$4{,}52 \cdot 10^{-7}$}{$4{,}52 \cdot 10^{7}$}{$45{,}2 \cdot 10^{6}$}{$452 \cdot 10^{5}$}
% Відповідь: В

\vspace{0.5cm}

\task{117}{Запишіть число 238 млн 500 тис. у стандартному вигляді. \nmtyear{gen}}
\answerTable{$2385 \cdot 10^5$}{$2{,}385 \cdot 10^{-8}$}{$2{,}385 \cdot 10^{8}$}{$23{,}85 \cdot 10^{7}$}{$238{,}5 \cdot 10^{6}$}
% Відповідь: В

\vspace{0.5cm}

\task{118}{Площа Азовського моря становить $39$ тис. км$^2$. Запишіть це число у стандартному вигляді. \nmtyear{gen}}
\answerTable{$39 \cdot 10^{4}$}{$3{,}9 \cdot 10^{-4}$}{$3{,}9 \cdot 10^{4}$}{$390 \cdot 10^{2}$}{$0{,}39 \cdot 10^{4}$}
% Відповідь: В

\vspace{0.5cm}

\task{119}{Діаметр атома водню приблизно дорівнює $0{,}0000000001$ м. Запишіть це число у стандартному вигляді. \nmtyear{gen}}
\answerTable{$1 \cdot 10^{-10}$}{$1 \cdot 10^{-9}$}{$10 \cdot 10^{-11}$}{$0{,}1 \cdot 10^{-9}$}{$1 \cdot 10^{10}$}
% Відповідь: А

\vspace{0.5cm}

\task{120}{Відстань від Землі до Сонця приблизно дорівнює $150$ млн км. Запишіть цю відстань у стандартному вигляді (у км). \nmtyear{gen}}
\answerTable{$15 \cdot 10^{7}$}{$1{,}5 \cdot 10^{-8}$}{$1{,}5 \cdot 10^{8}$}{$150 \cdot 10^{6}$}{$0{,}15 \cdot 10^{8}$}
% Відповідь: В
...
\answerTable{$2^{32}$}{$2^{34}$}{$8^{30}$}{$2^{120}$}{$2^{31}$}
...
\answerTable{$1{,}67 \cdot 10^{-31}$ кг}{$1{,}67 \cdot 10^{-23}$ кг}{$1{,}67 \cdot 10^{-24}$ кг}{$1{,}67 \cdot 10^{-26}$ кг}{$167 \cdot 10^{-23}$ кг}
% Відповідь: Б
...
\answerTable{$2{,}7 \cdot 10^{22}$}{$2{,}7 \cdot 10^{16}$}{$2{,}7 \cdot 10^{19}$}{$2{,}7 \cdot 10^{25}$}{$2700 \cdot 10^{22}$}
...
\answerTable{$4 \cdot 10^{30}$ кг}{$2 \cdot 10^{31}$ кг}{$2 \cdot 10^{60}$ кг}{$4 \cdot 10^{60}$ кг}{$2 \cdot 10^{29}$ кг}
% Відповідь: А
...
\answerTable{$5 \cdot 10^{-3}$ кг}{$5 \cdot 10^{-2}$ кг}{$5 \cdot 10^{-4}$ кг}{$2{,}5 \cdot 10^{-3}$ кг}{$2{,}5 \cdot 10^{-4}$ кг}
...
\answerTable{$3 \cdot 10^{7}$}{$3 \cdot 10^{4}$}{$3 \cdot 10^{10}$}{$4{,}8 \cdot 10^{4}$}{$4{,}8 \cdot 10^{7}$}
...
\answerTable{$1{,}02 \cdot 10^{2}$ км}{$1{,}7 \cdot 10^{3}$ км}{$1{,}02 \cdot 10^{5}$ м}{$1{,}7 \cdot 10^{2}$ км}{$3{,}4 \cdot 10^{2}$ км}
...
\answerTable{$c^{72}$}{$c^{15}$}{$c^{17}$}{$c^{36}$}{$c^{13}$}
% Відповідь: В (c^9 * c^8 = c^17)

\vspace{0.5cm}

\task{129}{Спростіть вираз $d^7 \cdot (d^2)^4$. \nmtyear{gen}}
\answerTable{$d^{56}$}{$d^{13}$}{$d^{15}$}{$d^{28}$}{$d^{11}$}
% Відповідь: В (d^7 * d^8 = d^15)

\vspace{0.5cm}

\task{130}{Обчисліть $20^3 \cdot 4^{-3}$. \nmtyear{gen}}
\answerTable{$0$}{$5$}{$1$}{$25$}{$125$}
% Відповідь: Д ((20/4)^3 = 5^3 = 125)

\vspace{0.5cm}

\task{131}{Обчисліть $24^4 \cdot 8^{-4}$. \nmtyear{gen}}
\answerTable{$0$}{$3$}{$1$}{$27$}{$81$}
% Відповідь: Д ((24/8)^4 = 3^4 = 81)

\vspace{0.5cm}

\task{132}{$4^{50} =$ \nmtyear{gen}}
\answerTableBig{$4^{5} \cdot 4^{10}$}{$\dfrac{4^{500}}{4^{10}}$}{$4^{25} + 4^{25}$}{$(4^{5})^{10}$}{$(4^{25})^{25}$}
% Відповідь: Г

\vspace{0.5cm}

\task{133}{$6^{36} =$ \nmtyear{gen}}
\answerTableBig{$6^{6} \cdot 6^{6}$}{$\dfrac{6^{360}}{6^{10}}$}{$6^{18} + 6^{18}$}{$(6^{6})^{6}$}{$(6^{18})^{18}$}
% Відповідь: Г

\vspace{0.5cm}

\task{134}{Спростіть вираз $4^{1+2x} \cdot 4^{1-2x}$. \nmtyear{gen}}
\answerTable{$4^{1-4x^2}$}{$8$}{$16^{1-4x^2}$}{$16$}{$4$}
% Відповідь: Г (4^2 = 16)

\vspace{0.5cm}

\task{135}{Спростіть вираз $7^{2+y} \cdot 7^{2-y}$. \nmtyear{gen}}
\answerTable{$7^{4-y^2}$}{$14$}{$49^{4-y^2}$}{$2401$}{$49$}
...
\answerTableBig{$\dfrac{11}{12}a^2$}{$\dfrac{5}{12}a^{-2}$}{$\dfrac{5}{2}a^{-2}$}{$\dfrac{5}{2}a$}{$\dfrac{5}{2}a^2$}
% Відповідь: Д

\vspace{0.5cm}

\task{137}{$\dfrac{7}{15}b^{-3} \cdot 5b^5 =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{12}{15}b^2$}{$\dfrac{7}{15}b^{-2}$}{$\dfrac{7}{3}b^{-2}$}{$\dfrac{7}{3}b$}{$\dfrac{7}{3}b^2$}
% Відповідь: Д

\vspace{0.5cm}

\task{138}{$\dfrac{0{,}0625^2}{0{,}125^2 \cdot 0{,}25} =$ \nmtyear{gen}}
\answerTable{$0{,}125$}{$0{,}25$}{$0{,}5$}{$1$}{$2$}
% Відповідь: Б

\vspace{0.5cm}

\task{139}{$\dfrac{c^{24}c^{-8}}{(4c^7)^2} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{c^{-8}}{8}$}{$\dfrac{c^2}{16}$}{$\dfrac{1}{16c^{18}}$}{$\dfrac{c^2}{8}$}{$\dfrac{c^6}{16}$}
% Відповідь: Б (c^16 / 16c^14 = c^2/16)

\vspace{0.5cm}

\task{140}{$\dfrac{d^{30}d^{-12}}{(5d^8)^2} =$ \nmtyear{gen}}
\answerTableBig{$\dfrac{d^{-12}}{10}$}{$\dfrac{d^2}{25}$}{$\dfrac{1}{25d^{20}}$}{$\dfrac{d^2}{10}$}{$\dfrac{d^8}{25}$}
