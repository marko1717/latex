...
\noindent{\small\color{gray!80} Розділ 6. Комбінаторика, теорія ймовірності, статистика \quad\textbullet\quad Усього завдань: 29 (НМТ \mbox{2024~--- 12}, \mbox{2025~--- 11}, \mbox{2026~--- 6}).}\par\vspace{0.2cm}
...
\nopagebreak\vspace{-0.3cm} % Піднімаємо вище
\begin{center}
...
\begin{multicols}{3}\noindent
\noindent\textbf{24.}~Д \ {\scriptsize\color{gray}(1.06, №7)}\par
\noindent\textbf{25.}~Б \ {\scriptsize\color{gray}(3.06, №5)}\par
\noindent\textbf{29.}~Д \ {\scriptsize\color{gray}(15.06, №11)}\par
\end{multicols}
\fi
