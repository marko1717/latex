...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 63 (НМТ \mbox{2023~--- 17}, \mbox{2024~--- 11}, \mbox{2025~--- 15}, \mbox{2026~--- 20}).}\par\vspace{0.2cm}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.45]
        ...
        \fill (-5,4) circle (3pt);
        \fill (5,1) circle (3pt);
        \node[fill=white, inner sep=1.5pt, right] at (-3, 2.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{nmtfit}\begin{tikzpicture}[scale=0.5]
        ...
        \fill (-2,1) circle (3pt);
        \fill (4,-2) circle (3pt);
        \node[fill=white, inner sep=1.5pt, right] at (2, 2.5) {$y=f(x)$};
    \end{tikzpicture}\end{nmtfit}
    \end{flushright}
\end{minipage}
...
\textit{Характеристика} \par\par\vspace{0.2cm}
...
\begin{nmtfit}\begin{tikzpicture}[scale=0.6, thick]
    ...
    \fill (-4,-1) circle (3pt);
    \fill (4,1) circle (3pt);
    \node[fill=white, inner sep=1.5pt, above right] at (1,1.5) {$y=f(x)$};
\end{tikzpicture}\end{nmtfit}
\end{minipage}
\par\vspace{0.2cm}
...
\begin{nmtfit}\begin{tikzpicture}[scale=0.45, thick]
    ...
    \node[fill=white, inner sep=1.5pt, above right, font=\small] at (4.5,5) {$y=f(x)$};
\end{tikzpicture}\end{nmtfit}
\end{minipage}
\par\vspace{0.2cm}
...
\begin{nmtfit}\begin{tikzpicture}[scale=0.5, thick]
    ...
    \node[fill=white, inner sep=1.5pt, right, font=\scriptsize] at (1.5,4.6) {$y=f(x)$};
\end{tikzpicture}\end{nmtfit}
\end{minipage}
\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{44.}~1~--~Д, 2~--~Б, 3~--~Г \ {\scriptsize\color{gray}(23.05, №18)}\par
\noindent\textbf{45.}~1~--~В, 2~--~Б, 3~--~Г \ {\scriptsize\color{gray}(30.05, №17)}\par
\noindent\textbf{46.}~1~--~В, 2~--~Г, 3~--~А \ {\scriptsize\color{gray}(1.06, №17)}\par
\noindent\textbf{47.}~Д \ {\scriptsize\color{gray}(2.06, №8)}\par
\noindent\textbf{48.}~В \ {\scriptsize\color{gray}(3.06, №8)}\par
\noindent\textbf{49.}~В \ {\scriptsize\color{gray}(4.06, №8)}\par
\noindent\textbf{50.}~1~--~Б, 2~--~В, 3~--~Г \ {\scriptsize\color{gray}(4.06, №17)}\par
\noindent\textbf{51.}~А \ {\scriptsize\color{gray}(5.06, №8)}\par
\noindent\textbf{52.}~1~--~В, 2~--~Б, 3~--~А \ {\scriptsize\color{gray}(5.06, №17)}\par
\noindent\textbf{59.}~Г \ {\scriptsize\color{gray}(15.06, №8)}\par
\noindent\textbf{60.}~А \ {\scriptsize\color{gray}(16.06, №8)}\par
\noindent\textbf{61.}~1--Г; 2--В; 3--А \ {\scriptsize\color{gray}(16.06, №17)}\par
\noindent\textbf{62.}~В \ {\scriptsize\color{gray}(17.06, №8)}\par
\noindent\textbf{63.}~А \ {\scriptsize\color{gray}(19.06, №8)}\par
\end{multicols}
\fi
