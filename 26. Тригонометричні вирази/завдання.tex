...
\noindent{\small\color{gray!80} Розділ 1. Числа і вирази \quad\textbullet\quad Усього завдань: 69 (НМТ \mbox{2023~--- 16}, \mbox{2024~--- 32}, \mbox{2025~--- 10}, \mbox{2026~--- 11}).}\par\vspace{0.2cm}
...
\matchingLayout{
    ...
    \textit{Точка} \par\par\vspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} l@{}}
    \textbf{А} & $K$ \\[0.2cm]
    \textbf{Б} & $L$ \\[0.2cm]
    \textbf{В} & $M$ \\[0.2cm]
...
\matchingLayout{
    ...
    \textit{Значення виразу} \par\par\vspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} l@{}}
    \textbf{А} & $1$ \\[0.2cm]
    \textbf{Б} & $2$ \\[0.2cm]
    \textbf{В} & $3$ \\[0.2cm]
...
\matchingLayout{
    ...
    \textit{Твердження про значення виразу} \par\par\vspace{0.2cm}
