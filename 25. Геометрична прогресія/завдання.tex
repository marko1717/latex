...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 23 (НМТ \mbox{2023~--- 4}, \mbox{2024~--- 9}, \mbox{2025~--- 6}, \mbox{2026~--- 4}).}\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{20.}~Б \ {\scriptsize\color{gray}(4.06, №10)}\par
\noindent\textbf{22.}~Г \ {\scriptsize\color{gray}(17.06, №10)}\par
\noindent\textbf{23.}~Г \ {\scriptsize\color{gray}(18.06, №10)}\par
\end{multicols}
\fi
