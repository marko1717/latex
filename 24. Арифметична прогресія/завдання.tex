...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 29 (НМТ \mbox{2023~--- 13}, \mbox{2024~--- 5}, \mbox{2025~--- 5}, \mbox{2026~--- 6}).}\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{24.}~В \ {\scriptsize\color{gray}(23.05, №6)}\par
\noindent\textbf{25.}~Г \ {\scriptsize\color{gray}(1.06, №5)}\par
\noindent\textbf{26.}~А \ {\scriptsize\color{gray}(2.06, №11)}\par
\noindent\textbf{27.}~А \ {\scriptsize\color{gray}(5.06, №15)}\par
\noindent\textbf{29.}~Д \ {\scriptsize\color{gray}(16.06, №10)}\par
\end{multicols}
\fi
