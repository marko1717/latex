...
\noindent{\small\color{gray!80} Розділ 4. Планіметрія \quad\textbullet\quad Усього завдань: 50 (НМТ \mbox{2023~--- 15}, \mbox{2024~--- 16}, \mbox{2025~--- 13}, \mbox{2026~--- 6}).}\par\vspace{0.2cm}
...
\begin{samepage}
\noindent\zadnum \begin{minipage}[t]{0.55\textwidth}
У рівнобічній трапеції $ABCD$ діагоналі $AC$ і $BD$ взаємно перпендикулярні і перетинаються в точці $O$, $KM$ --- середня лінія трикутника $AOD$, $BO = 6\sqrt{2}$ \textit{см}, $KM = 12$ \textit{см} (див. рисунок). До кожного відрізка \mbox{(1--3)} доберіть його довжину \mbox{(А--Д)}. \nmtyear{2023}
\end{minipage}
\hfill
\begin{minipage}[t]{0.4\textwidth}
    \nopagebreak\vspace{-0.3cm}
...
\textit{Довжина} \par\par\vspace{0.2cm}
    \begin{tabular}{ll}
    \textbf{А} & 10 \textit{см} \\
    \textbf{Б} & 6 \textit{см} \\
    \textbf{В} & 8 \textit{см} \\
...
\end{center}
\nopagebreak\vspace{0.3cm}
\noindent Установіть відповідність між величиною \mbox{(1--3)} та її значенням \mbox{(А--Д)}.
\nopagebreak\vspace{0.3cm}
\noindent
...
\centering
\begin{nmtfit}\begin{tikzpicture}[scale=0.27, thick]
    \coordinate (A) at (0,0);
...
\begin{multicols}{3}\noindent
\noindent\textbf{45.}~1~--~Б, 2~--~А, 3~--~Г \ {\scriptsize\color{gray}(23.05, №16)}\par
\noindent\textbf{46.}~Д \ {\scriptsize\color{gray}(2.06, №3)}\par
\noindent\textbf{49.}~В \ {\scriptsize\color{gray}(16.06, №14)}\par
\noindent\textbf{50.}~1--В,\ \ 2--Г,\ \ 3--А \ {\scriptsize\color{gray}(19.06, №18)}\par
\end{multicols}
\fi
