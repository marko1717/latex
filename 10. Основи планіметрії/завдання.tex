...
\noindent{\small\color{gray!80} Розділ 4. Планіметрія \quad\textbullet\quad Усього завдань: 33 (НМТ \mbox{2023~--- 7}, \mbox{2024~--- 9}, \mbox{2025~--- 8}, \mbox{2026~--- 9}).}\par\vspace{0.2cm}
...
\nopagebreak\vspace{0.3cm}
\begin{minipage}[t]{0.42\textwidth}
\answerTableSmall{лише III}{лише II}{лише I}{лише I та II}{лише I та III}
\end{minipage}
\hfill
\begin{minipage}[t]{0.52\textwidth}
\begin{flushright}
...
\nopagebreak\vspace{0.3cm}
\begin{minipage}[t]{0.42\textwidth}
\answerTableSmall{лише III}{лише II та III}{лише I та III}{I, II та III}{лише II}
\end{minipage}
\hfill
\begin{minipage}[t]{0.52\textwidth}
\begin{flushright}
...
\noindent\textbf{32.}~1--Б,\ \ 2--А,\ \ 3--Г \ {\scriptsize\color{gray}(18.06, №18)}\par
\noindent\textbf{33.}~Б \ {\scriptsize\color{gray}(19.06, №3)}\par
\end{multicols}
\fi
