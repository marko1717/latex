...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2023--2026 \textendash{} Тема 15}
...
\noindent{\small\color{gray!80} Розділ 4. Планіметрія \quad\textbullet\quad Усього завдань: 36 (НМТ \mbox{2023~--- 7}, \mbox{2024~--- 12}, \mbox{2025~--- 12}, \mbox{2026~--- 5}).}\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{32.}~А \ {\scriptsize\color{gray}(30.05, №3)}\par
\noindent\textbf{36.}~В \ {\scriptsize\color{gray}(16.06, №9)}\par
\end{multicols}
\fi
