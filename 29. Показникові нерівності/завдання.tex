...
\answerTableTall{$\left[\displaystyle\frac{1}{7}; +\infty\right)$}{$[-2; +\infty)$}{$(-\infty; -2]$}{$\left(-\infty; \displaystyle\frac{1}{243}\right]$}{$\left(-\infty; \displaystyle\frac{1}{2}\right]$}

% === ЗАВДАННЯ 10 ===
\noindent\textbf{10.} Розв'яжіть нерівність $\left(\displaystyle\frac{1}{4}\right)^{2x-6} > \displaystyle\frac{1}{16}$. \nmtyear{2025}

\answerTable{$(4; +\infty)$}{$(-\infty; 4)$}{$(-\infty; -2)$}{$(-2; +\infty)$}{$(-\infty; 2)$}

% === ЗАВДАННЯ 11 ===
\noindent\textbf{11.} Розв'яжіть нерівність $3^x \cdot 5^x \leqslant \displaystyle\frac{1}{15}$. \nmtyear{2025}

\answerTableTall{$\left(-\infty; \displaystyle\frac{1}{15}\right]$}{$[-1; +\infty)$}{$[1; +\infty)$}{$(-\infty; -1]$}{$(-\infty; 1]$}

% === ЗАВДАННЯ 12 ===
\noindent\textbf{12.} Розв'яжіть нерівність $2^{3-x} > \displaystyle\frac{1}{4}$. \nmtyear{2025}

\answerTable{$(-\infty; -1)$}{$(5; +\infty)$}{$(-5; +\infty)$}{$(-\infty; 5)$}{$(-1; +\infty)$}

% === ЗАВДАННЯ 13 ===
\noindent\textbf{13.} Розв'яжіть нерівність $10^{x-2} > 1$. \nmtyear{2025}

\answerTable{$(-2; +\infty)$}{$(2; +\infty)$}{$(2{,}1; +\infty)$}{$(-\infty; 2)$}{$(3; +\infty)$}
