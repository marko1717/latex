...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2023--2026 \textendash{} Тема 14}
...
\noindent{\small\color{gray!80} Розділ 4. Планіметрія \quad\textbullet\quad Усього завдань: 25 (НМТ \mbox{2023~--- 5}, \mbox{2024~--- 5}, \mbox{2025~--- 7}, \mbox{2026~--- 8}).}\par\vspace{0.2cm}
...
\begin{multicols}{3}\noindent
\noindent\textbf{18.}~А \ {\scriptsize\color{gray}(23.05, №13)}\par
\noindent\textbf{19.}~1~--~Д, 2~--~А, 3~--~Г \ {\scriptsize\color{gray}(30.05, №16)}\par
\noindent\textbf{20.}~Д \ {\scriptsize\color{gray}(1.06, №10)}\par
\noindent\textbf{24.}~Д \ {\scriptsize\color{gray}(15.06, №4)}\par
\noindent\textbf{25.}~В \ {\scriptsize\color{gray}(18.06, №3)}\par
\end{multicols}
\fi
