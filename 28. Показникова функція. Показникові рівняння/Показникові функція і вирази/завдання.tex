...
\begin{minipage}[t]{0.50\textwidth}
    \textit{Тотожно рівний вираз} \par\par\nbvspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} p{6.2cm}@{}}
    \textbf{А} & $8^a$ \\[0.2cm]
    \textbf{Б} & $8 + a$ \\[0.2cm]
    \textbf{В} & $8a$ \\[0.2cm]
    \textbf{Г} & $8 - a$ \\[0.2cm]
    \textbf{Д} & $\displaystyle\frac{a}{8}$ \\[0.35cm]
    \end{tabular}
\end{minipage}
\nopagebreak\nbvspace{0.3cm}
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \textbf{В} & $a = m - n$. \\[0.2cm]
    \textbf{Г} & $a = n$. \\[0.2cm]
    \textbf{Д} & $a = \displaystyle\frac{m}{n}$. \\[0.35cm]
    \end{tabular}
\end{minipage}
\nopagebreak\nbvspace{0.3cm}
...
\hfill
\begin{minipage}[t]{0.50\textwidth}
    \textit{Найменше значення на $[0; 4]$} \par\par\nbvspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} p{6.2cm}@{}}
    \textbf{А} & $1$ \\[0.2cm]
    \textbf{Б} & $2$ \\[0.2cm]
    \textbf{В} & $3$ \\[0.2cm]
...
\hfill
\begin{minipage}[t]{0.50\textwidth}
    \textit{Найбільше значення на $[-1; 3]$} \par\par\nbvspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} p{6.2cm}@{}}
    \textbf{А} & $1$ \\[0.2cm]
    \textbf{Б} & $2$ \\[0.2cm]
    \textbf{В} & $3$ \\[0.2cm]
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \textbf{1} & $y = x$ \\[0.4cm]
    \textbf{2} & $y = 2^{-x}$ \\[0.4cm]
    \textbf{3} & $y = \displaystyle\frac{1}{x}$ \\[0.35cm]
    \end{tabular}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.50\textwidth}
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \textbf{Д} & $a = \displaystyle\frac{n}{3}$. \\[0.35cm]
    \end{tabular}
\end{minipage}
\nopagebreak\nbvspace{0.3cm}
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \textbf{2} & $2^{-a}$ \\[0.4cm]
    \textbf{3} & $\displaystyle\frac{10}{a}$ \\[0.35cm]
    \end{tabular}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.50\textwidth}
    \textit{Множина} \par\par\nbvspace{0.2cm}
    \begin{tabular}{@{}p{0.5cm} p{6.2cm}@{}}
...
\begin{minipage}[t]{0.30\textwidth}
    ...
    \textbf{2} & $1 - \pi$ \\[0.4cm]
    \textbf{3} & $\left(\displaystyle\frac{1}{2}\right)^{\log_2 \pi}$ \\[0.35cm]
    \end{tabular}
\end{minipage}%
\hfill
...
\begin{minipage}[t]{0.30\textwidth}
    ...
    \textbf{Д} & $n = \displaystyle\frac{m}{2}$. \\[0.35cm]
    \end{tabular}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.20\textwidth}
