...
\noindent{\small\color{gray!80} Розділ 3. Функції \quad\textbullet\quad Усього завдань: 38 (НМТ \mbox{2023~--- 16}, \mbox{2024~--- 8}, \mbox{2025~--- 7}, \mbox{2026~--- 7}); \mbox{тестових~--- 2}; \mbox{на відповідність~--- 36}.}\par\vspace{0.2cm}
...
\begin{samepage}
% НМТ 2026, сесія 4.06, завдання №16 --- основна тема: Квадратні корені. Корені вищих степенів. Раціональний степінь
...
\begin{samepage}
% НМТ 2026, сесія 8.06, завдання №17 --- основна тема: Функція та її властивості
...
\begin{samepage}
% НМТ 2026, сесія 12.06, завдання №17 --- основна тема: Функція та її властивості
\zadtask{Доберіть до функції \mbox{(1--3)} її властивість \mbox{(А--Д)}. \nmtyear{2026}\par
\nopagebreak\nbvspace{0.3cm}
\noindent
\matchingLayout{
...
\begin{samepage}
% НМТ 2026, сесія 15.06, завдання №17 --- основна тема: Графіки елементарних функцій, їх побудова та перетворення
...
\begin{samepage}
% НМТ 2026, сесія 18.06, завдання №17 --- основна тема: Графіки елементарних функцій, їх побудова та перетворення
...
\begin{multicols}{3}\noindent
\noindent\textbf{32.}~1~--~В, 2~--~Г, 3~--~А \ {\scriptsize\color{gray}(1.06, №17)}\par
\noindent\textbf{33.}~1~--~А, 2~--~Д, 3~--~Б \ {\scriptsize\color{gray}(4.06, №16)}\par
\noindent\textbf{36.}~1--Б, 2--А, 3--Г \ {\scriptsize\color{gray}(15.06, №17)}\par
\noindent\textbf{37.}~1--Г; 2--В; 3--А \ {\scriptsize\color{gray}(16.06, №17)}\par
\noindent\textbf{38.}~1--В,\ \ 2--Д,\ \ 3--Г \ {\scriptsize\color{gray}(18.06, №17)}\par
\end{multicols}
\fi
