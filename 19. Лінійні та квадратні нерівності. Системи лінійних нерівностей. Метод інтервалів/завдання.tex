...
\answerTableTall{$(-4; +\infty)$}{$\left(-\dfrac{1}{4}; +\infty\right)$}{$\left(-\infty; -\dfrac{1}{4}\right)$}{$\left(-\dfrac{3}{4}; +\infty\right)$}{$(-\infty; -4)$}
...
\answerTable{$(-\infty; 8)$}{$(4; 8)$}{$(-\infty; -3)$}{$(-3; 10)$}{$(-3; 8)$}
...
\answerTable{$[-0{,}5; +\infty)$}{$[2; +\infty)$}{$[-2; +\infty)$}{$(0{,}5; +\infty)$}{$[0{,}5; +\infty)$}
...
\answerTable{$(-\infty; 6]$}{$(-\infty; -3]$}{$[-3; +\infty)$}{$(-\infty; 3]$}{$[3; +\infty)$}
...
\answerTable{$(-\infty; -3)$}{$(-\infty; 3]$}{$(-\infty; -3]$}{$[-3; +\infty)$}{$(-3; +\infty)$}
...
\answerTableTall{$[-18; +\infty)$}{$(-\infty; -2]$}{$(-\infty; -18]$}{$\left[-\dfrac{1}{18}; +\infty\right)$}{$[-2; +\infty)$}
...
\answerTable{$[-4; 2{,}5)$}{$(-\infty; -4]$}{$(-\infty; 2{,}5)$}{$(2{,}5; +\infty)$}{$[-4; +\infty)$}
...
\answerTableTall{$\left(-\infty; \dfrac{4}{3}\right)$}{$\left(-\infty; \dfrac{3}{4}\right)$}{$\left(\dfrac{3}{4}; +\infty\right)$}{$\left(\dfrac{2}{3}; +\infty\right)$}{$\left(\dfrac{4}{3}; +\infty\right)$}
...
\answerTable{$\left(-\infty; \dfrac{8}{3}\right)$}{$(8; +\infty)$}{$(-8; +\infty)$}{$(-\infty; 8)$}{$(-\infty; -8)$}

\vspace{0.5cm}

% Завдання 22
\noindent\textbf{22.} Розв'яжіть нерівність $4(x - 2) \leqslant 2$. \nmtyear{2024}
\answerTable{$[2{,}5; +\infty)$}{$(-\infty; 2{,}5]$}{$[1; +\infty)$}{$(-\infty; 1]$}{$(-\infty; 1{,}5]$}
