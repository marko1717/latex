...
\fancyhead[C]{\small\color{gray!80} База завдань НМТ 2022--2026 \textendash{} Тема 12}
...
\nmtnobreak
\matchingLayout{
\matchItem{1}{Сторона $AB$}
\matchItem{2}{Сторона $AD$}
\matchItem{3}{Діагональ $AC$}
}{
    \matchItem{А}{$5\sqrt{2}$ \textit{см}}
\matchItem{Б}{$10\sqrt{2}$ \textit{см}}
\matchItem{В}{$5\sqrt{6}$ \textit{см}}
\matchItem{Г}{$10$ \textit{см}}
...
\matchItem{Г}{$\sqrt{145}$ \textit{см}}
\matchItem{Д}{$\sqrt{194}$ \textit{см}}
}{
    \matchingGrid
}
\par\penalty-20\vspace{0.25cm}
...
\nmtnobreak
\matchingLayout{
\matchItem{1}{Висота, проведена до $AD$}
\matchItem{2}{Проєкція $AB$ на $AD$}
\matchItem{3}{$AB$}
}{
...
\matchItem{3}{Відстань від точки $B$ до сторони $CD$}
    ...
    \matchItem{А}{$\dfrac{120}{17}$ \textit{см}}
