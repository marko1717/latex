...
\noindent{\small\color{gray!80} Розділ 4. Планіметрія \quad\textbullet\quad Усього завдань: 31 (НМТ \mbox{2023~--- 8}, \mbox{2024~--- 12}, \mbox{2025~--- 5}, \mbox{2026~--- 6}).}\par\vspace{0.2cm}
...
\answerTableSmall{$1{,}5\sqrt{85}$}{$21$}{$10{,}5$}{$3\sqrt{85}$}{$18$}
\end{minipage}
\hfill
...
\nopagebreak\vspace{0.3cm}
\begin{minipage}[t]{0.42\textwidth}
\answerTableSmall{$4\sqrt{2}$ \textit{см}}{$\sqrt{10}$ \textit{см}}{$\dfrac{4\sin 50°}{\sin 55°}$ \textit{см}}{$2\sqrt{5}$ \textit{см}}{$\dfrac{4\sin 55°}{\sin 50°}$ \textit{см}}
\end{minipage}
\hfill
\begin{minipage}[t]{0.52\textwidth}
\begin{flushright}
...
\nopagebreak\vspace{0.3cm}
\begin{minipage}[t]{0.42\textwidth}
\answerTableSmall{$60$ \textit{см}$^2$}{$30$ \textit{см}$^2$}{$36$ \textit{см}$^2$}{$30\sqrt{2}$ \textit{см}$^2$}{$60\sqrt{2}$ \textit{см}$^2$}
\end{minipage}
\hfill
\begin{minipage}[t]{0.52\textwidth}
\begin{flushright}
...
\begin{multicols}{3}\noindent
\noindent\textbf{26.}~1~--~Г, 2~--~В, 3~--~А \ {\scriptsize\color{gray}(1.06, №18)}\par
\noindent\textbf{27.}~А \ {\scriptsize\color{gray}(4.06, №14)}\par
\noindent\textbf{30.}~Б \ {\scriptsize\color{gray}(17.06, №14)}\par
