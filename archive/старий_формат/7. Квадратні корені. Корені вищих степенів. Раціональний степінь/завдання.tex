...
\answerTableBig{$-\sqrt{5}$}{$-\dfrac{\sqrt{5}}{5}$}{$1$}{$\dfrac{\sqrt{5}}{5}$}{$\sqrt{5}$}
...
\answerTableBig{$\dfrac{11}{25}$}{$1\dfrac{\sqrt{11}}{5}$}{$\dfrac{5}{6}$}{$1\dfrac{1}{5}$}{$2\dfrac{1}{5}$}

\vspace{0.5cm}

% Завдання 14
\task{14}{$\left(\dfrac{1}{7} \cdot \sqrt[3]{7}\right)^3 =$ \nmtyear{2023}}
\answerTableBig{$\dfrac{1}{7}$}{$49$}{$\dfrac{1}{49}$}{$7$}{$1$}
...
\answerTableBig{$1{,}5$}{$\dfrac{1}{6}$}{$\dfrac{2}{3}$}{$6$}{$\dfrac{2\sqrt{3}}{9}$}
...
\answerTableBig{$\dfrac{\sqrt{x} + 3}{2}$}{$\dfrac{2}{\sqrt{x} - 3}$}{$1{,}5$}{$\dfrac{\sqrt{x} - 3}{2}$}{$\dfrac{2}{\sqrt{x} + 3}$}
...
\answerTableBig{$1{,}5$}{$1$}{$0{,}5$}{$3$}{$\dfrac{1}{6}$}
...
\task{401}{$\sqrt{20} \cdot \sqrt{5} - 1 =$ \nmtyear{2025}}
\answerTable{$4\sqrt{5}$}{$9$}{$2\sqrt{6}$}{$4$}{$3\sqrt{11}$}

\vspace{0.5cm}

% Завдання 402 (НМТ 2023, основна сесія) --- з тематичного збірника «Числа і вирази»
\task{402}{$\dfrac{\sqrt{9} - \sqrt{4}}{\sqrt{5}} =$ \nmtyear{2023}}
\answerTableBig{$-\dfrac{\sqrt{5}}{5}$}{$-\sqrt{5}$}{$\dfrac{\sqrt{5}}{5}$}{$1$}{$\sqrt{5}$}

\vspace{0.5cm}

% Завдання 403 (НМТ 2022, демоваріант) --- з тематичного збірника «Числа і вирази»
\task{403}{Установіть відповідність між виразом (1--3) та проміжком (А--Д), якому належить його значення. \nmtyear{2022}}
