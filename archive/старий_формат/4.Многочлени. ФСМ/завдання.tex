...
% Завдання 12
\task{12}{$(a + b)^{-2} =$ \nmtyear{2024}}
\answerTableBig{$\dfrac{1}{a^2 + b^2}$}{$\dfrac{a^2 + b^2}{a^2b^2}$}{$\dfrac{1}{a^2 + 2ab + b^2}$}{$-a^2 - 2ab - b^2$}{$-a^2 - b^2$}
...
\task{201}{Розкладіть на множники $x^2 - 6x + 5$. \nmtyear{2024}}
...
\task{202}{Розкладіть на множники $x^2 - 5x - 6$. \nmtyear{2024}}
...
\task{203}{Спростіть вираз $3(1 - x)(1 + x)$. \nmtyear{2022}}
