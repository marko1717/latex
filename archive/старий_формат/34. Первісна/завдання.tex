...
\vspace{0.3cm}
\answerTable{$3x^2$}{$2x^2$}{$\dfrac{x^4}{4} + C$}{$3x$}{$3x^2 + 4$}
...
\vspace{0.3cm}
\answerTable{$b < c < a$}{$c < a < b$}{$a < b < c$}{$b < a < c$}{$c < b < a$}
...
\vspace{0.3cm}
\answerTable{$b < a < c$}{$c < a < b$}{$a < b < c$}{$c < b < a$}{$b < c < a$}
