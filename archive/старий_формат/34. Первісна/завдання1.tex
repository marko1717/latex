...
% === ЗАВДАННЯ 30 ===
\noindent\textbf{30.} Обчисліть $\displaystyle\int\limits_0^{\pi} 2\sin x \, dx$. \nmtyear{2025}
...
% === ЗАВДАННЯ 31 ===
\noindent\textbf{31.} Визначте загальний вигляд первісних для функції $f(x) = 2e^x + 1$. \nmtyear{2025}
...
% === ЗАВДАННЯ 32 ===
\noindent\textbf{32.} Укажіть первісну функції $f(x) = 3\cos x - x$. \nmtyear{2025}
...
% === ЗАВДАННЯ 34 ===
\noindent\textbf{34.} Обчисліть інтеграл $\displaystyle\int\limits_1^5 3f(x) dx$, якщо $\displaystyle\int\limits_1^5 f(x) dx = 14$. \nmtyear{2025}
...
% === ЗАВДАННЯ 35 ===
\noindent\textbf{35.} Функція $F(x) = 4x^3 - 3x^2 + 9$ є первісною для функції $f(x)$ на проміжку $(-\infty; +\infty)$.
...
% === ЗАВДАННЯ 37 ===
\noindent\textbf{37.} Визначте ординату точки перетину графіка функції $y=f(x)$ із віссю $y$, якщо функція $F(x) = x^3 + x^2 - 7x + 1$ є первісною для функції $f(x)$. \nmtyear{2025}
...
% === ЗАВДАННЯ 38 ===
\noindent\textbf{38.} Обчисліть інтеграл $\displaystyle\int\limits_2^5 \dfrac{x^2+4x+4}{x+2} dx$. \nmtyear{2025}
...
% === ЗАВДАННЯ 39 ===
\noindent\textbf{39.} Відомо, що $\displaystyle\int\limits_{-1}^2 f(x) dx = 9$, $\displaystyle\int\limits_{-1}^2 g(x) dx = -7$. Обчисліть $\displaystyle\int\limits_{-1}^2 (3f(x) - 2g(x) + 6x) dx$. \nmtyear{2025}
