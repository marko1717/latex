...
\noindent\textbf{95.} Увідповідніть функцію (1--3) із кількістю (А--Д) спільних точок її графіка з прямою $y=1$.
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{96.} Установіть відповідність між функцією (1--3) та властивістю (А--Д) її графіка.
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{97.} \begin{minipage}[t]{0.55\textwidth}
У прямокутній системі координат на площині зображено ламану $ABCDA$ (див. рисунок). Увідповідніть функцію (1--3) із кількістю (А--Д) спільних точок її графіка з ламаною $ABCDA$.
 \nmtyear{2023}
\end{minipage}
\hfill
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{98.} \begin{minipage}[t]{0.55\textwidth}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{99.} Установіть відповідність між твердженням (1--3) та функцією (А--Д), для якої це твердження є правильним. \nmtyear{2023}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{100.} Установіть відповідність між функцією (1--3) та властивістю її графіка (А--Д).
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{101.} \begin{minipage}[t]{0.55\textwidth}
У прямокутній декартовій системі координат на площині зображено замкнену ламану $ABCA$, де $A(-1; 0)$, $B(0; 1)$, $C(1; 0)$. Узгодьте функцію (1--3) з кількістю (А--Д) спільних точок її графіка та ламаної $ABCA$.
 \nmtyear{2024}
\end{minipage}
\hfill
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{102.} \begin{minipage}[t]{0.55\textwidth}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{103.} Установіть відповідність між функцією (1--3) та кількістю спільних точок (А--Д) її графіка з прямою $y=-1$. \nmtyear{2024}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{104.} Установіть відповідність між функцією (1--3) та її властивістю її графіка (А--Д). \nmtyear{2024}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{105.} Установіть відповідність між функцією (1--3) та кількістю спільних точок (А--Д) її графіка з прямою $y=x$. \nmtyear{2024}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{106.} Установіть відповідність між функцією (1--3) та її властивістю її графіка (А--Д). \nmtyear{2024}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{107.} Доберіть до функції (1--3) координатні чверті (А--Д), у яких лежить графік цієї функції (координатні чверті показано на рисунку). \nmtyear{2025}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{108.} Узгодьте функцію (1--3) із її властивістю (А--Д). \nmtyear{2025}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{109.} Доберіть до функції (1--3) властивість її графіка (А--Д). \nmtyear{2025}
...
% перенесено з теми 26: завдання про графік або властивості функції
\noindent\textbf{110.} Увідповідніть функцію (1--3) та її властивість (А--Д).
