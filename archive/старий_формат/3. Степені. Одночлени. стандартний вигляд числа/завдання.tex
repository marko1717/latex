...
\answerTableBig{$\dfrac{2}{5}$}{$\dfrac{5}{2}$}{$1$}{$\dfrac{5}{4}$}{$\dfrac{1}{2}$}
...
\answerTableBig{$\dfrac{1}{40}$}{$10^4$}{$\dfrac{1}{25}$}{$\dfrac{1}{8}$}{$\dfrac{5}{8}$}
...
\answerTableBig{$\dfrac{1}{2x}$}{$\dfrac{3}{2x^4}$}{$\dfrac{2}{x^3}$}{$\dfrac{4}{x^3}$}{$\dfrac{2}{x^4}$}
...
\answerTableBig{$\dfrac{11}{3}$}{$\dfrac{3}{11}$}{$\dfrac{11}{9}$}{$33$}{$\dfrac{1}{33}$}
...
\answerTableBig{$\dfrac{12}{125}a^{8}$}{$\dfrac{64}{125}a^{8}$}{$\dfrac{64}{125}a^{125}$}{$\dfrac{12}{125}a^{15}$}{$\dfrac{64}{125}a^{15}$}
...
\answerTableBig{$\dfrac{9}{11}$}{$990$}{$\dfrac{11}{9}$}{$33$}{$99$}
...
\answerTableBig{$\dfrac{5}{4}$}{$1$}{$-1\dfrac{1}{4}$}{$\dfrac{1}{4}$}{$\dfrac{4}{5}$}
...
\answerTableBig{$1\dfrac{3}{2}$}{$-1\dfrac{2}{3}$}{$\dfrac{3}{5}$}{$\dfrac{5}{3}$}{$1{,}5$}
...
% Завдання 9
\task{47}{$3^{100} =$ \nmtyear{2025}}
\answerTableBig{$3^{50} + 3^{50}$}{$3^{10} \cdot 3^{10}$}{$(3^{50})^{50}$}{$(3^{10})^{10}$}{$\dfrac{3^{1000}}{3^{10}}$}

\vspace{0.5cm}

% Завдання 10
\task{48}{$\dfrac{2}{9}y^{-2} \cdot 3y^4 =$ \nmtyear{2025}}
\answerTableBig{$\dfrac{2}{9}y^{-2}$}{$\dfrac{5}{9}y^2$}{$\dfrac{2}{3}y^{-2}$}{$\dfrac{2}{3}y$}{$\dfrac{2}{3}y^2$}
...
\answerTableBig{$0{,}25$}{$\dfrac{1}{256}$}{$0{,}0025$}{$1{,}25$}{$8$}
...
\answerTableBig{$\dfrac{a^{-4{,}5}}{6}$}{$\dfrac{1}{9a^{18}}$}{$\dfrac{a^3}{6}$}{$\dfrac{a^3}{9}$}{$\dfrac{a^7}{9}$}
...
\task{301}{$0{,}2 \cdot 10^3 =$ \nmtyear{2025}}
\answerTable{$0{,}6$}{$2000$}{$200$}{$6$}{$20$}

\vspace{0.5cm}

% Завдання 302 (НМТ 2025, додаткова сесія) --- з тематичного збірника «Числа і вирази»
\task{302}{Один моль Фосфору містить $6{,}02 \cdot 10^{23}$ атомів. Скільки атомів буде містити $1000$ моль Фосфору? \nmtyear{2025}}
