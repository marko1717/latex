...
## 📚 База завдань НМТ 2023--2026 по темах (єдиний формат)

Усі завдання основних сесій НМТ 2023--2026 зібрано **по темах** в одному форматі запису
...
* `<N>. <Тема>/завдання.tex` --- самостійний документ теми (XeLaTeX/LuaLaTeX). Усередині завдання
  згруповано за роками (`\typeTitle{НМТ 2023}` … `\typeTitle{НМТ 2026}`), нумерація наскрізна.
