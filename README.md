...
* Завдання **на встановлення відповідності** мають єдиний макет: три колонки
  (пункти 1--3, варіанти А--Д, сітка праворуч), однаковий відступ між пунктами,
  мітки в колонці сталої ширини, продовження довгого пункту вирівняне під текстом.
  За це відповідають макроси `\matchHead`, `\matchItem`, `\matchingLayout`
  і функція `unify_matching()` у скрипті збірки.
